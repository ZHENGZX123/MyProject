...
public class TopicMatcher {
    ...
    public static boolean isValid(String topicFilter, boolean allowWildcard) {
        ...
        if (allowWildcard) {
            if (topicFilter.equals(MULTI_LEVEL_WILDCARD) || topicFilter.equals(SINGLE_LEVEL_WILDCARD)) {
                return true;
            }
    ...
    private static int countMatches(String str, String sub) {
        if (str == null || "".equals(str) || sub == null || "".equals(sub)) {
            return 0;
        }
    ...
    public static boolean match(String topicFilter, String topicName) {
        if (!TopicMatcher.isValid(topicFilter, true) || !TopicMatcher.isValid(topicName, false)) {
            return false;
        }
