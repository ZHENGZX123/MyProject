...
public class DownloadingFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Context context = getContext();
        contentView = inflater.inflate(R.layout.marker_fragment_downloading, container, false);
    ...
    private class DownloadAdapter extends RecyclerView.Adapter<DownloadViewHolder> {
        ...
        public DownloadViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = inflater.inflate(R.layout.marke_layout_downloading_list_item, parent, false);
