...
exports.default = {
	...
	methods: {
		...
		light: function light(index, id) {
			...
			// console.log(njId);
			_Utils2.default.fetch({
				url: '/app/book/list/?moduleId=' + self.subjId + '&grade=' + self.njId + '&type=' + id + '&page=' + self.page + '&pageSize=10' + '&schoolId=' + self.schoolId,
				method: 'POST',
				type: 'json',
				success: function success(ret) {
					// const modal = weex.requireModule('modal');
...
exports.default = {
	...
	methods: {
		cut: function cut(index, id) {
			...
			// console.log(njId);
			_Utils2.default.fetch({
				url: '/app/student/rank/?loginAccount=' + self.Account + '&page=' + self.page + '&pageSize=8&type=' + self.tabsId,
				method: 'POST',
				type: 'json',
				...
				success: function success(ret) {
					...
					if (ret.data.status == 200 && datas.info.length != 0) {
						for (var _i = 0; _i < datas.info.length; _i++) {
							self.list.push(datas.info[_i]);
						}
					} else if (ret.data.status == 200 && datas.info.length == 0 && self.tabsId == 1) {
		...
		methods: {
				...
				openVoice: function openVoice() {
						...
						sjevent.PostSigalVoice(function (ret) {
						  modal.toast({   message: ret.url + ret.duration,
                                          duration: 0.3
                                   });
						  });
				},
...
exports.default = {
	...
	created: function created() {
		var self = this;
		_Utils2.default.fetch({
			url: '/app/information/?page=' + self.page + '&pageSize=20',
			method: 'POST',
			type: 'json',
			success: function success(ret) {
				var data = ret.data.result;
