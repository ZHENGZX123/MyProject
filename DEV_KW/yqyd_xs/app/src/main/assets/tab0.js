...
exports.default = new _vueRouter2.default({
  ...
  { path: '/', name: 'index', component: __webpack_require__(1) }, { path: '/index', name: 'index', component: __webpack_require__(1) },

  // 阅读任务
  { path: '/ydrw', name: 'ydrw', component: __webpack_require__(18) },
  // 任务详情
  { path: '/ydrw/ckjh', name: 'ydrw_jh', component: __webpack_require__(19) },
  // 阅读任务详情
  { path: '/ydrw_xq', name: 'ydrw_xq', component: __webpack_require__(24) },
  // 阅读任务 写读后感
  { path: '/ydrw/xdhg', name: 'ydrw_xdhg', component: __webpack_require__(23) },
  // 阅读任务 我的读后感
  { path: '/ydrw/wddhg', name: 'ydrw_wddhg', component: __webpack_require__(22) },
  // 阅读任务 开始闯关
  { path: '/ydrw/kscg', name: 'ydrw_kscg', component: __webpack_require__(20) },
  // 阅读任务 我的闯关
  { path: '/ydrw/wdcg', name: 'ydrw_wdcg', component: __webpack_require__(21) },

  //考试提分宝
  { path: '/kstfb', name: 'kstfb', component: __webpack_require__(16) },

  // 书香榜
  { path: '/sxb', name: 'sxb', component: __webpack_require__(17) },
  // // 阅读资讯
  { path: '/ydzx', name: 'ydzx', component: __webpack_require__(25) },
  // 阅读资讯 详情
  { path: '/ydzx/xq', name: 'ydzx_xq', component: __webpack_require__(26) }]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("长按识别二维码，关注[一起阅读]公众号")]), _c('text', {
    staticStyle: {
      fontSize: "32px"
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: ["count"]
  }, [_vm._v(_vm._s(_vm.index) + "/" + _vm._s(_vm.length))])]), _c('div', {
    staticClass: ["content"]
  }, [_c('div', [_c('div', {
    staticClass: ["question"]
  }, [_c('text', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.openwdfx('/ydrw/wddhg?planId=' + _vm.rwId + '&bookId=' + _vm.bId)
      }
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('scroller', {
    ...
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          _vm.jumps('/ydrw/ckjh?planId=' + rw.planId + '&type=' + rw.type)
        }
      }
    }, [_c('div', {
      staticClass: ["jrrw_info"]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["photoList"]
  }, [_vm._l((_vm.imageUrl), function(lPic) {
    return _c('div', {
      staticStyle: {
        padding: "10px"
      },
