...
exports.default = new _vueRouter2.default({
  ...
  */
  ...
  // 消息中心
  { path: '/main/wdxx', name: 'wdxx', component: __webpack_require__(20) },

  // 我的分享
  { path: '/main/wdfx', name: 'wdfx', component: __webpack_require__(18) },

  // 我的收藏
  { path: '/main/wdsc', name: 'wdsc', component: __webpack_require__(19) },

  // 设置
  { path: '/main/sz', name: 'sz', component: __webpack_require__(17) },
  // 个人信息
  { path: '/main/grxx', name: 'grxx', component: __webpack_require__(16) },
  // 修改密码
  { path: '/main/xgmm', name: 'xgmm', component: __webpack_require__(21) }]
...
exports.default = {
	...
	methods: {
		...
		onblur1: function onblur1(event) {
			...
			if (!reg.test(event.value) || !re.text(event.value)) {
				this.text = '电话号码错误';
				modal.alert({
					message: '电话号码错误',
					duration: 0.3,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.xzsex))])])]), _c('scroller', [_c('div', {
    staticClass: ["List"]
  }, [_c('div', {
    staticClass: ["wrapper"]
  }, [_c('text', {
