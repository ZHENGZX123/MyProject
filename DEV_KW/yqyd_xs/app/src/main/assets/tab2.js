...
exports.default = new _vueRouter2.default({
  ...
  */
  // 个人首页
  { path: '/main', name: 'main', component: __webpack_require__(15) },
...
exports.default = {
	data: function data() {
		...
		return _ref = {
			...
			qq: '',
			email: ''
		}, _defineProperty(_ref, 'sex', ''), _defineProperty(_ref, 'schoolName', ''), _defineProperty(_ref, 'Img', ''), _defineProperty(_ref, 'avatar', ''), _defineProperty(_ref, 'disabled', false), _defineProperty(_ref, 'stateList', [{ name: '男', bj: '', color: '#666', id: 0 }, { name: '女', bj: '', color: '#666', id: 1 }]), _defineProperty(_ref, 'imgUrl', ''), _defineProperty(_ref, 'loginA', '10099521'), _ref;
	},
	...
	methods: {
		...
		submit: function submit() {
			...
			if (self.newPwd != self.newPwd1 || self.newPwd == '') {
				...
				_Utils2.default.fetch({
					url: '/app/student/uc/changePwd?loginAccount=' + self.loginA,
					method: 'POST',
					type: 'json',
					data: '&oldPwd=' + self.oldPwd + '&newPwd=' + self.newPwd + '&newPwd1=' + self.newPwd,
					success: function success(ret) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    on: {
      "input": function($event) {
        _vm.schoolName = $event.target.attr.value
      }
    }
  })])])]), (_vm.xb) ? _c('div', {
    staticClass: ["s_class"]
