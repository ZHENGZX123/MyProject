...
exports.default = new _vueRouter2.default({
  // mode: 'abstract',
  routes: [{ path: '/login', name: 'login', component: __webpack_require__(16) }, { path: '/wjmm', name: 'wjmm', component: __webpack_require__(15) }]
			...
			_Utils2.default.fetch({
				...
				success: function success(ret) {
					...
					if (ret && ret.data.errcode == 200) {
						...
						_Utils2.default.getAccessToken(params, self, function () {
							if (true) {
