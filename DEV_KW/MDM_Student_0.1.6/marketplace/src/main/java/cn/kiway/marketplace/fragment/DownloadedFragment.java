...
public DownloadedFragment(){super();}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Context context = getContext();
        contentView = inflater.inflate(R.layout.marke_fragment_downloaded, container, false);
    ...
    private class DownloadAdapter extends RecyclerView.Adapter<DownloadViewHolder> {
        ...
        public DownloadViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = inflater.inflate(R.layout.marker_layout_downloaded_list_item, parent, false);
