...
public class MyVideoView extends WXComponent<FrameLayout> {
    ...
    @Deprecated
    public MyVideoView(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String instanceId, boolean isLazy) {
        this(instance, dom, parent, isLazy);
    }

    public MyVideoView(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, boolean isLazy) {
        ...
        video.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                ...
                if (getDomObject().getEvents().contains(Constants.Event.FAIL)) {
                    MyVideoView.this.notify(Constants.Event.FAIL, Constants.Value.STOP);
                }
                return true;
            }
        });
        ...
        video.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if (getDomObject().getEvents().contains(Constants.Event.FINISH)) {
                    MyVideoView.this.notify(Constants.Event.FINISH, Constants.Value.STOP);
                }
            }
        });
        ...
        video.setOnVideoPauseListener(new WXVideoView.VideoPlayListener() {
            ...
            public void onPause() {
                ...
                if (getDomObject().getEvents().contains(Constants.Event.PAUSE)) {
                    MyVideoView.this.notify(Constants.Event.PAUSE, Constants.Value.PAUSE);
                }
            }
            ...
            public void onStart() {
                ...
                if (getDomObject().getEvents().contains(Constants.Event.START)) {
                    MyVideoView.this.notify(Constants.Event.START, Constants.Value.PLAY);
                }
            }
        });
        mWrapper = video;
