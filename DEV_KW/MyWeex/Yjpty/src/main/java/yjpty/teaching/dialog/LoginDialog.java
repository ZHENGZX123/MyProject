...
import yjpty.teaching.views.LVCircularRing;
...
public class LoginDialog extends BaseDialog implements OnDismissListener {
	...
	public LoginDialog(Context context) {
		super(context);
		// 首先得到整个View
		View view = LayoutInflater.from(context).inflate(R.layout.yjpty_login_dialog,
				null);
		// 获取整个布局
		...
		// 显示文本
		// 显示文本
		loadingText.setText(context.getResources().getString(R.string.download));
		// 创建自定义样式的Dialog
