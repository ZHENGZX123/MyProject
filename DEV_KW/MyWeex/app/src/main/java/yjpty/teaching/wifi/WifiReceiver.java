...
import cn.kiway.baas.sdk.model.App;
...
public class WifiReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (app == null)
            app = (WXApplication) context.getApplicationContext();
            ...
            if (null != parcelableExtra) {
                ...
                if (isConnected && !state.equals(State.CONNECTING)
                    ...
                    if (app.getChangeWifi()) {
                        wifiName = SharedPreferencesUtil.getString(WXApplication
                                        .getInstance().getApplicationContext(),
                                IConstant.WIFI_NEME + app.classModels.get(app.getClassPosition()).getId());
                        if (AppUtil.getConnectWifiSsid(
                                WXApplication.getInstance().getApplicationContext()).equals(
                                wifiName)) {
                        ...
                        if (AppUtil.getConnectWifiSsid(
                                WXApplication.getInstance().getApplicationContext()).equals(
                                wifiName)
                                && SharedPreferencesUtil.getBoolean(WXApplication
                                        .getInstance().getApplicationContext(),
                            ...
                            SharedPreferencesUtil.save(WXApplication.getInstance()
