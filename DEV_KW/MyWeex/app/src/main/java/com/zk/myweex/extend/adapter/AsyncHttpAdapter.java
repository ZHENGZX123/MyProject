...
public class AsyncHttpAdapter implements IWXHttpAdapter {
    ...
    public void sendRequest(final WXRequest request, final OnHttpListener listener) {
        ...
        Map<String, String> all = (Map<String, String>) WXApplication.application.getSharedPreferences("kiway_weex", 0).getAll();
                    ...
                    for (Header h : headers) {
                        ...
                        if (h.getName().equals("Set-Cookie") && h.getValue().contains("JSESSIONID")) {
                            ...
                            if (value.contains("JSESSIONID")) {
                                WXApplication.application.getSharedPreferences("kiway_weex", 0).edit().putString(path, jsessionid).commit();
                            }
                        }
                    }
