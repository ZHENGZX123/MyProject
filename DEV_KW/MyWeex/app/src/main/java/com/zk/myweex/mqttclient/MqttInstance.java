...
import com.zk.myweex.mqttclient.mq.TopicProcessService;
...
//        conMqtt();
    ...
    public void conMqtt(String name, String pwd, final LoginImlisener loginImlisener) {
        //Log.i("用户名和密码", SharedPreferencesUtil.getString(contexts, IConstant.USER_NAME)+"---------"+SharedPreferencesUtil.getString(contexts, IConstant.PASSWORD));
