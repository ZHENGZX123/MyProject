	      ...
	      "children": [
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.gotoMembers(this.id,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    }, (0, _defineProperty3.default)(_data, 'myClass', []), (0, _defineProperty3.default)(_data, 'classMembers', []), (0, _defineProperty3.default)(_data, 'classMemberUrl', 'class-members'), _data),
	    created: function created() {
	    ...
	    methods: {
	        gotoMembers: function gotoMembers(classId) {
	            var self = this;
	            Utils.fetch({
