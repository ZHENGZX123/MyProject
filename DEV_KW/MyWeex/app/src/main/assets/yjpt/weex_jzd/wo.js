...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_bootstrap__('@weex-component/ff55f55f95278e8f2113354ed38cc4a9',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        navBarHeight: 130,
	        basicDataList: [{ titleName: '姓名', src: 'yjpt/images/arrows_right.png', lName: '请选择（必填） ', url: 'name' }, { titleName: '性别', src: 'yjpt/images/arrows_right.png', lName: '男', url: 'gender-setting' }, { titleName: '地区', src: 'yjpt/images/arrows_right.png', lName: '深圳市  南山区 ', url: 'wd_wo_dz' }],
	        myPortraitUrl: '',
	        userId: '',
	        address: '未知',
	        name: '未知',
	    ...
	    created: function created() {
	        ...
	        this.arrRight = Utils.ip + Utils.dir + '/' + 'yjpt/images/arrows_right.png';
	        this.myPortraitUrl = Utils.ip + Utils.dir + '/' + 'yjpt/images/photo_06.jpeg';
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.data.StatusCode == '200') {
	                        ...
	                        if (user.avatar) {
	                            self.myPortraitUrl = user.avatar;
	                        }
	    ...
	    methods: {
	        openNamePage: function openNamePage() {
	        ...
	        addOpenPage: function addOpenPage() {
	            var self = this;
	                    ...
	                    if (SJevent.PostSigalImg) {
	                        ...
	                        SJevent.PostSigalImg(paramJson, function (res) {
	                            if (res == 0) {
	                                ...
	                                self.myPortraitUrl = res.path;

	                                Utils.fetch({
	                                    url: '/app/user',
	                                    data: 'userId=' + self.userId + '&avatar=' + res.path,
	                                    type: 'json',
	                                    method: 'POST',
	                                    success: function success(ret) {
	                                        var _data = ret.data;
	                                        ...
	                                        if (obj.StatusCode == '200') {
	                                            modal.toast({
	                                                message: '头像修改成功，等待审核中...',
	                                                duration: '1'
	                                            });

	                                            var userImg = new BroadcastChannel('userImg');
	                                            userImg.postMessage(res.path);
