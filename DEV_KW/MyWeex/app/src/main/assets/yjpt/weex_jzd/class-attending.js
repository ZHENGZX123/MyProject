	      ...
	      "children": [
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": "3：换取卡资源后，如盒子上方显示资源不对时,请重启盒子"
	              }
	            }
	          ]
	        },
	        {
	          ...
	          "shown": function () {return this.myClass.length>0},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return '（' + (this.gradeId) + '）'}
	                  }
	                },
	                {
	                  "type": "text",
	                  ...
	                  "shown": function () {return this.mac},
	                  "attr": {
	                    "value": function () {return this.mac}
	                  }
	                }
	              ]
	            },
	              ...
	              "children": [
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.redirect(this.url,this.id,this.gradeId,$event)}
	                  },
	                  "attr": {
	                    "value": "点击上课"
	                  }
	                },
	                {
	                  ...
	                  "shown": function () {return !this.mac},
	                  "events": {
	                    "click": function ($event) {this.scanToClass(this.id,this.gradeId,$event)}
	                  },
	                  "attr": {
	                    "value": "扫码上课"
	                  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        this.leftItemImg = Utils.ip + Utils.dir + '/' + this.leftItemImg;
	    ...
	    methods: {
	        redirect: function redirect(url, classId, gradeId) {
	            var self = this;

	            storage.setItem('classId', classId, function () {});

	            var grade;
	            for (var i in self.gradeList) {
	                if (self.gradeList[i].name == gradeId) {
	                    grade = self.gradeList[i].id;
	                }
	            }
	        ...
	        scanToClass: function scanToClass(classId, gradeId) {
	            var self = this;
	            storage.setItem('classId', classId, function () {});
