...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/6d4d97ceef4d4e6af4f625834fe8793e', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/6d4d97ceef4d4e6af4f625834fe8793e',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.selected(this.index,$event)}
	              },
	              "children": [
	                {
	                  "type": "text",
	        ...
	        },
	        {
	          ...
	          "shown": function () {return this.courseType=='all'},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	              ...
	              "children": [
	                      ...
	                      "children": [
	                        {
	                          "type": "image",
	                          "attr": {
	                            "src": function () {return this.images.search}
	                          },
	                          "classList": [
	                            "searchPic"
	                          ]
	                        },
	                        {
	                          ...
	                          "attr": {
	                            ...
	                            "name": "",
	                            "placeholder": "请输入关键字",
	                            "value": function () {return this.searchAllTxt}
	                          },
	                          "events": {
	                            "focus": "clearAllTxt",
	                            "input": "searchAll"
	                ...
	                },
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.redirect(this.id,this.$index,$event)}
	                  },
	                  "shown": function () {return this.lessonList.length>0},
	                  "children": [
	                    {
	                      "type": "div",
	                      "children": [
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return (this.count) + '/' + (this.section_count)}
	                              }
	                            },
	                            {
	                              "type": "image",
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "repeat": function () {return this.fields},
	                              "style": {
	                                "marginRight": 10
	                              },
	                              "attr": {
	                                "value": function () {return this.fields[this.$index]}
	                              }
	                            }
	                          ]
	                        }
	        ...
	        },
	        {
	          ...
	          "shown": function () {return this.courseType=='myCourse'},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.openUrl('1',this.id,this.sectionType?'teacher':null,this.aim,this.teaching_prepare,$event)}
	                  },
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "shown": function () {return this.count>0},
	                              "attr": {
	                                "value": "已上课"
	                              }
	                            },
	                            {
	                              ...
	                              "events": {
	                                "click": function ($event) {this.openUrl('2',this.id,this.sectionType?'teacher':null,this.aim,this.teaching_prepare,$event)}
	                              },
	                              "attr": {
	                                "src": function () {return this.images.playBtn}
	                              }
	                            }
	                          ]
	                        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        redirect: function redirect(courseId, index) {
	            var self = this;

	            var url;
	            if (self.courseType == 'all') {
	                storage.setItem('courseInfo', (0, _stringify2.default)(self.lessonList[index]), function () {});
	                url = Utils.setOpenUrl(this.$getConfig(), 'catalogTab');
	            } else if (self.courseType == 'myCourse') {
	                storage.setItem('courseInfo', (0, _stringify2.default)(self.myCourse[index]), function () {});
	        ...
	        selected: function selected(index) {
	            ...
	            if (index == 0) {
	                self.courseType = 'all', storage.getItem('grade', function (e) {
	                    if (e.data != 'undefined') {
	                        Utils.fetch({
	                            url: '/app/course?classId=' + self.classId + '&gradeId=' + e.data,
	                            method: 'get',
	                            dataType: 'json',
	                            success: function success(res) {
	                                if (res.data.StatusCode == '200') {
	                                    ...
	                                    for (var i in self.lessonList) {
	                                        ...
	                                        self.imgLoad(i, self.lessonList);
	                                    }

	                                    self.tempList = [].concat(JSON.parse((0, _stringify2.default)(self.lessonList)));
	                                } else {
	                                    modal.toast({
	                    ...
	                    success: function success(res) {
	                        if (res.data.StatusCode == '200') {
	                            ...
	                            for (var i in self.myCourse) {
	                                ...
	                                self.imgLoad(i, self.myCourse);
	                            }
	                            self.tempList = [].concat(JSON.parse((0, _stringify2.default)(self.myCourse)));
	                        } else {
	                            modal.toast({
	                                message: '获取课程失败，请稍后重试',
	                                duration: '1'
	        ...
	        searchAll: function searchAll(e) {
	            var self = this;

	            self.searchAllTxt = e.value;
	            self.noContainList = [];
	            self.lessonList = JSON.parse((0, _stringify2.default)(self.tempList));
	            ...
	            if (self.searchAllTxt != '') {
	                ...
	                console.log('lessonList:', self.lessonList);
	            } else {
	                self.lessonList = JSON.parse((0, _stringify2.default)(self.tempList));
	            }
	        },
	        searchMyCourse: function searchMyCourse(e) {
	            var self = this;

	            self.searchAllTxt = e.value;
	            self.noContainList = [];
	            self.myCourse = JSON.parse((0, _stringify2.default)(self.tempList));
	        ...
	        clearAllTxt: function clearAllTxt(e) {
	            var self = this;
	        },

	        openUrl: function openUrl(opType, sectionId, sectionType, aim, prepare) {
	            var self = this;
	        ...
	        imgLoad: function imgLoad(i, arr) {
	            var self = this;
	            Utils.fetch({
	                url: arr[i].icon,
	                dataType: 'json',
