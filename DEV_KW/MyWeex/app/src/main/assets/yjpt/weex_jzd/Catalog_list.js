...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/ff56df480cea708878978b187a8fb526', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/ff56df480cea708878978b187a8fb526',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "title": function () {return this.courseInfo.name},
	    "titleColor": "white",
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                  ...
	                  "children": [
	                    {
	                      "type": "text",
	                      "attr": {
	                        "value": function () {return '共' + (this.sectionList.length) + '个课时'}
	                      }
	                    }
	                  ]
	                },
	                {
	                  ...
	                  "repeat": function () {return this.sectionList},
	                  "events": {
	                    "click": function ($event) {this.openUrl('1',this.id,this.aim,this.teaching_prepare,$event)}
	                  },
	                  "children": [
	                    {
	                      "type": "div",
	                        ...
	                        },
	                        {
	                          ...
	                          "children": [
	                            ...
	                            },
	                            {
	                              ...
	                              "events": {
	                                "click": function ($event) {this.openUrl('2',this.id,this.aim,this.teaching_prepare,$event)}
	                              },
	                              "attr": {
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.classify}
	                              }
	                            }
	                          ]
	                        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftItemImg', 'rightArrow', 'noImgs']);
	                        ...
	                        Utils.fetch({
	                            ...
	                            success: function success(res) {
	                                if (res.data.StatusCode == '200') {
	                                    ...
	                                    for (var i in self.sectionList) {
	                                        self.imgLoad(i, self.sectionList);
	                                    }
	                                    storage.setItem('sectionList', (0, _stringify2.default)(self.sectionList), function () {});
	                                } else {
	                                    modal.toast({
	    ...
	    methods: {
	        ...
	        openUrl: function openUrl(opType, sectionId, aim, prepare) {
	            var self = this;
