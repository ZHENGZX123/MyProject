...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/573e95994b554f1d79e2cc9cb8f217b9', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/573e95994b554f1d79e2cc9cb8f217b9',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "title": function () {return this.lession.lessonName},
	    "titleColor": "white",
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.lession.teachingAim}
	                      }
	                    }
	                  ]
	                }
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.lession.teachingPrepare}
	                      }
	                    }
	                  ]
	                }
	            ...
	            },
	            {
	              ...
	              "repeat": function () {return this.sectinList},
	              "children": [
	                {
	                  "type": "text",
	                  "classList": [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Utils = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./javascripts/Utils\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	module.exports = {
	    data: function () {return {
	        ...
	        detailList: [{ listTitle: '教学目标', listContent: "1、能够在老师的提示下，清楚地讲出故事的主要情节； 2、知道分享的意义，能够与别人分享； 3、熟悉的儿歌《这是我的松果》和《大家一起来分享》" }, { listTitle: '课前准备', listContent: "1、能够在老师的提示下，清楚地讲出故事的主要情节； 2、知道分享的意义，能够与别人分享； 3、熟悉的儿歌《这是我的松果》和《大家一起来分享》" }],
	        videoList: [{ index: '01', videoContent: '查看完整视频。。。' }, { index: '02', videoContent: '在老师的带领下做。。。' }],
	        classId: '',
	        lessionId: '',
	        lession: {},
	        sectinList: []
	        ...
	        storage.getItem('hasVideo', function (e) {
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.status == '200') {
	                        self.lession = JSON.parse((0, _stringify2.default)(ret.data.lesson));
	                        self.sectinList = JSON.parse((0, _stringify2.default)(ret.data.sectinList));
