...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        var self = this;
	        storage.getItem('contactName', function (e) {
	            if (e.data) {
	                self.userData.name = e.data;
	            }
	        });
	        storage.getItem('contactPhone', function (e) {
	            if (e.data) {
	                self.userData.tel = e.data;
	            }
	        });

	        storage.getItem('photo', function (e) {
	            if (e.data != 'undefined') {
	                self.images.userImg = e.data;
	            }
	        });
