	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.childInfo.child_name}
	                      }
	                    },
	                    {
	                      "type": "div",
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "shown": function () {return this.childInfo.sex=='女'}
	                            },
	                            {
	                              "type": "image",
	                              "classList": [
	                              ...
	                              "shown": function () {return this.childInfo.sex=='男'}
	                            },
	                            {
	                              "type": "text",
	                              "classList": [
	                              ...
	                              "shown": function () {return this.childInfo.sex!=''},
	                              "attr": {
	                                "value": function () {return this.childInfo.sex}
	                              }
	                            }
	                          ]
	                        },
	                    ...
	                    },
	                    {
	                      ...
	                      "children": [
	                        ...
	                        },
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.parent_type}
	                          }
	                        },
	                        {
	                          "type": "image",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        Utils.changeImg(this.images, ['leftItemImg', 'userImg', 'rightItemImg', 'arrowRight', 'femaleImg', 'maleImg', 'birthImg', 'defaultPhoto']);
	        ...
	        var self = this;
	        storage.getItem('contactId', function (e) {
	            if (e.data != 'undefined') {
	                Utils.fetch({
	                    url: '/classChildren/search',
	                    data: 'childId=' + e.data,
	                    type: 'json',
	                    method: 'POST',
	                    success: function success(ret) {
	                        if (ret.data.retcode == '1') {
	                            self.childInfo = JSON.parse((0, _stringify2.default)(ret.data.children));
	                            self.childInfo.birthday = self.childInfo.birthday == null ? '' : self.childInfo.birthday;
	                            self.childInfo.sex = self.childInfo.sex == null ? '' : self.childInfo.sex;

	                            self.childInfo.avatar = self.childInfo.avatar == null ? self.images.defaultPhoto : Utils.ip + self.dir + self.childInfo.avatar;

	                            self.parentList = JSON.parse((0, _stringify2.default)(ret.data.parentList));

	                            for (var i = 0; i < self.parentList.length; i++) {
	                                self.setDefaultPhoto(i, self.parentList[i].photo);
	                                if (self.parentList[i].parent_type == '1') {
	                                    self.parentList[i].parent_type = '爸爸';
	                                } else if (self.parentList[i].parent_type == '2') {
	                                    self.parentList[i].parent_type = '妈妈';
	                                } else {
	                                    self.parentList[i].parent_type = '其他';
	                                }
	                            }

	                            if (self.childInfo.sex == '1') {
	                                self.childInfo.sex = '男';
	                            } else if (self.childInfo.sex == '2') {
	                                self.childInfo.sex = '女';
	                            }
	                            storage.setItem('childId', ret.data.children.id, function () {});
	                        } else {
	                            modal.toast({
	                                message: '网络故障，请稍后再试！',
	                                duration: '1'
	    ...
	    methods: {
	                            ...
	                            Utils.fetch({
	                                ...
	                                success: function success(ret) {
	                                    if (ret.data.retcode == '1') {
	                                        ...
	                                        setTimeout(function () {
	                                            Utils.navigate.push(this, self.mainPage, 'true');
	                                        }, 1000);
	                                    } else {
	                                        modal.toast({
	                                            message: '网络故障，请稍后再试！',
	        ...
	        redirectContact: function redirectContact(url, index) {
	            var self = this;
	            storage.setItem('parentId', self.parentList[index].id, function () {});
	            storage.setItem('parentName', self.parentList[index].name, function () {});
	            storage.setItem('parentPhone', self.parentList[index].phone, function () {});
	            storage.setItem('parentPhoto', self.parentList[index].photo, function () {});
