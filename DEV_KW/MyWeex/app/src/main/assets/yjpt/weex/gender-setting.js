...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/1345df1879043e087601fea29a2a59ab', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/1345df1879043e087601fea29a2a59ab',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        gender: [{ sex: '男', type: '1', status: '' }, { sex: '女', type: '2', status: '' }],
	        userSex: '1',
	        mineUrl: 'mine'
	    }},
	    created: function created() {
	        ...
	        storage.getItem('sex', function (e) {
	            ...
	            for (var i in self.gender) {
	                self.gender[i].status = self.gender[i].type == self.userSex ? self.images.selectRadio : self.images.blankRadio;
	            }
	        });
	        ...
	        this.$on('naviBar.rightItem.click', function (e) {
	            Utils.fetch({
	                ...
	                data: 'userId=' + userId + '&sex=' + this.userSex,
	                type: 'json',
	                method: 'POST',
	    ...
	    methods: {
	        radioCheck: function radioCheck(index) {
	            if (this.gender[index].status == this.images.blankRadio) {
	                ...
	                this.userSex = this.gender[index].type;
	            }
	        }
	    }
	};}
