...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/061e3277cc5cf862d09ebe5f4347602d', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/061e3277cc5cf862d09ebe5f4347602d',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "src": function () {return this.images.wifiImg}
	              }
	            },
	            {
	              "type": "image",
	              ...
	              "attr": {
	                "src": function () {return this.images.baoheImg}
	              }
	            }
	          ]
	        },
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.redirect(this.classUrl,'false',$event)}
	          },
	          "attr": {
	            "value": "只看教案备课"
	          }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        displayLoading: 'show',
	        dir: 'yjpt',
	        attendUrl: 'class-calendar',
	        classUrl: 'class-calendar',
	        images: {
	            leftItemImg: 'yjpt/images/id_right_bg.png',
	            phoneImg: 'yjpt/images/yjpt.png',
	            wifiImg: 'yjpt/images/wifi.png',
	            baoheImg: 'yjpt/images/bh.png'
	        },
	        pageTitle: '',
	        classId: ''
	    }},
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftItemImg', 'phoneImg', 'wifiImg', 'baoheImg']);
	        ...
	        this.attendUrl = base + this.attendUrl + '.js';
	    ...
	    methods: {
	        redirect: function redirect(url, hasVideo) {
	            storage.setItem('hasVideo', hasVideo, function () {});
	            Utils.navigate.push(this, url, 'true');
	        },
	        teachClass: function teachClass() {
	            var self = this;
	            ...
	            if (event.teachClass) {
	                event.teachClass({
	                    ...
	                    if (res.result == '1') {
	                        Utils.navigate.push(self, self.classUrl, 'true');
	                    }
	                });
	            } else {
	                modal.alert({
