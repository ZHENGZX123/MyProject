...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/60965f1a752e7af58b62b124e5b87220', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/60965f1a752e7af58b62b124e5b87220',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "type": "url",
	            "autofocus": "false",
	            "value": function () {return this.classData.className}
	          },
	          "events": {
	            "input": "classNameIn"
	          }
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        storage.getItem('className', function (e) {
	            self.classData.className = e.data;
	            self.countRemain = self.countRemain - self.classData.className.length;
	        });
	        ...
	        this.$on('naviBar.rightItem.click', function (e) {
	            storage.getItem('classId', function (e) {
	                classId = e.data;
	                Utils.fetch({
	                    url: '/yjpclass/updateClass',
	                    data: 'schoolId=' + schoolId + '&classId=' + classId + '&className=' + self.classData.className,
	                    type: 'json',
	                    method: 'POST',
	                    success: function success(ret) {
	                        if (ret.data.retcode == '1') {
	                            modal.alert({
	                                ...
	                                storage.setItem('className', self.classData.className);
	    ...
	    methods: {
	        classNameIn: function classNameIn(e) {
	            this.classData.className = e.value;
	            this.countRemain = this.numberCount - e.value.length;
	            if (this.countRemain <= 0) {
	                this.countRemain = 0;
	                this.classData.className = e.value.substring(0, this.numberCount);
	            }
	        }
	    }
	};}
