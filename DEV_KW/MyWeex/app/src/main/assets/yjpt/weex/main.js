...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_bootstrap__('@weex-component/1c1387baa494f5d6890223956afd6e71',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "shown": function () {return this.isJoinClass},
	          "events": {
	            "change": function ($event) {this.sliderChange($event)}
	          },
	          "children": [
	            {
	              "type": "div",
	              ...
	              "events": {
	                "click": function ($event) {this.classPage(this.classUrl,this.$index,$event)}
	              },
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": function () {return this.images.ewmImg}
	                  },
	                  "classList": [
	                    "ewm"
	                  ]
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return (this.className) + '（' + (this.gradeId) + '）'}
	                  }
	                },
	                {
	                  "type": "div",
	                  ...
	                  "children": [
	                    {
	                      "type": "image",
	                      "attr": {
	                        "src": function () {return this.images.faceImg}
	                      },
	                      "classList": [
	                        "face_img"
	                      ]
	                    },
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.childNum}
	                      }
	                    }
	                  ]
	                }
	              ...
	              "children": [
	                {
	                  ...
	                  "repeat": function () {return this.optionsRow1},
	                  "style": {
	                    "backgroundColor": function () {return this.bgColor},
	                    "borderColor": function () {return this.borderColor}
	                  },
	                  "events": {
	                    "click": function ($event) {this.redirect(this.url,$event)}
	                  },
	                  "children": [
	                    {
	                      "type": "image",
	              ...
	              "children": [
	                {
	                  ...
	                  "repeat": function () {return this.optionsRow2},
	                  "style": {
	                    "backgroundColor": function () {return this.bgColor},
	                    "borderColor": function () {return this.borderColor}
	                  },
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.redirect(this.classListUrl,$event)}
	              },
	              "attr": {
	                "value": "加入班级"
	              }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        dir: 'yjpt',
	        classUrl: 'class-main-page',
	        options: [{ name: '我要上课', iconUrl: 'yjpt/images/yjpt_lb02.png', bgColor: '#99CC33', borderColor: '#ffe9e9', url: 'class-attending' }, { name: '班级圈', iconUrl: 'yjpt/images/camera_index.png', bgColor: '#8496ef', borderColor: '#ffe9e9', url: 'class-circle' }, { name: '成长足迹', iconUrl: 'yjpt/images/foot_index.png', bgColor: '#38cc9e', borderColor: '#a9ddff', url: 'student-record' }, { name: '在校情况', iconUrl: 'yjpt/images/school_index.png', bgColor: '#2baaff', borderColor: '#dfdff4', url: 'student-info2' }, { name: '学校新闻', iconUrl: 'yjpt/images/news_index.png', bgColor: '#FF9999', borderColor: '#ffede6', url: 'news' }],
	        images: {
	            ewmImg: 'yjpt/images/ewm.png',
	            faceImg: 'yjpt/images/face.jpg'
	        },
	        imageList: [{ src: 'yjpt/images/ewm.png' }, { src: 'yjpt/images/ewm.png' }, { src: 'yjpt/images/ewm.png' }],
	        optionsRow1: [],
	        optionsRow2: [],
	        optionsRow3: [],
	        classList: [],
	        ...
	        classListUrl: 'class-list',
	        doneLoad: false,
	        classId: '',
	        school: ''
	    }},
	    created: function created() {
	        Utils.changeImg(this.images, ['ewmImg', 'faceImg']);
	        Utils.changeImg(this.options, ['iconUrl']);
	        Utils.changeImg(this.imageList, ['src']);
	        ...
	        for (var i = 0; i < this.options.length; i++) {
	            var myList = this.options[i];
	            if (myList.url) {
	                myList.url = base + myList.url + '.js';
	            }
	        }

	        this.classUrl = base + this.classUrl + '.js';
	        this.createUrl = base + this.createUrl + '.js';
	        this.classListUrl = base + this.classListUrl + '.js';

	        this.optionsRow1 = this.options.slice(0, 3);
	        this.optionsRow2 = this.options.slice(3, 6);
	        this.optionsRow3 = this.options.slice(6, 9);
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    ...
	                    if (ret.data.retcode == '1') {
	                        ...
	                        self.classList = JSON.parse((0, _stringify2.default)(ret.data.classList));
	                        self.classListCopy = JSON.parse((0, _stringify2.default)(ret.data.classList));
	                        self.school = JSON.parse((0, _stringify2.default)(ret.data.school));

	                        if (self.classList.length <= 0) {
	                            self.isJoinClass = false;
	                            return;
	                        }

	                        self.isJoinClass = true;
	                        self.doneLoad = true;
	                        storage.setItem('isJoinClass', self.isJoinClass, function () {});

	                        var classId = self.classList[0].id;
	                        storage.setItem('classId', classId, function () {});
	                        for (var i = 0; i < self.classList.length; i++) {
	                            if (self.classList[i].gradeId == '4') {
	                                self.classList[i].gradeId = '小班';
	                            } else if (self.classList[i].gradeId == '3') {
	                                self.classList[i].gradeId = '中班';
	                            } else if (self.classList[i].gradeId == '2') {
	                                self.classList[i].gradeId = '大班';
	                            } else {
	                                self.classList[i].gradeId = '大大班';
	                            }

	                            self.classList[i].childNum = self.classList[i].childNum == null ? 0 : self.classList[i].childNum;
	                        }

	                        self.classId = self.classList[0].id;
	                        Utils.fetch({
	                            url: '/performance/childList',
	                            data: 'classId=' + self.classId,
	                            type: 'json',
	                            method: 'POST',
	                            success: function success(ret) {
	                                if (ret.data.retcode == '1') {
	                                    self.childrenList = JSON.parse((0, _stringify2.default)(ret.data.childrenList));
	                                    self.typeList = JSON.parse((0, _stringify2.default)(ret.data.typeList));

	                                    for (var i = 0; i < self.childrenList.length; i++) {
	                                        self.childrenList[i].radioStatus = [];
	                                        var q = { status: '' };
	                                        for (var j = 0; j < 3; j++) {
	                                            self.childrenList[i].radioStatus.push(q);
	                                        }
	                                    }
	                                    storage.setItem('childrenList', (0, _stringify2.default)(self.childrenList), function () {});
	                                    storage.setItem('typeList', (0, _stringify2.default)(self.typeList), function () {});
	                                } else {
	                                    modal.toast({
	                                        message: '网络故障，请稍后重试！',
	                                        duration: '1'
	        ...
	        storage.removeItem('isNewUser', function () {
	            console.log('isNewUser is remove');
	        });
	        storage.setItem('joinedClass', '', function () {});
	    },
	    methods: {
	        redirect: function redirect(url) {
	            Utils.navigate.push(this, url, 'true');
	        },
	        classPage: function classPage(url, index) {
	            var classId, className, grade, schoolId, ownerId, school;
	            var self = this;

	            classId = self.classList[index].id;
	            className = self.classList[index].className;
	            grade = self.classList[index].gradeId;
	            schoolId = self.classList[index].schoolId;
	            ownerId = self.classList[index].owner;
	            school = self.school;

	            storage.setItem('classId', classId, function () {});
	            storage.setItem('className', className, function () {});
	            storage.setItem('grade', grade, function () {});
	            storage.setItem('schoolId', schoolId, function () {});
	            storage.setItem('school', school, function () {});
	            storage.setItem('ownerId', ownerId, function () {});
	            storage.setItem('classHCode', self.classList[index].hCode, function () {});

	            Utils.navigate.push(this, url, 'true');
	        },
	        sliderChange: function sliderChange(e) {
	            var self = this;
	            var classId = self.classList[e.index].id;
	            var gradeId = self.classListCopy[e.index].gradeId;

	            storage.setItem('classId', classId, function () {});
	            storage.setItem('gradeId', gradeId, function () {});
	        },
	        QRScan: function QRScan(url) {
	            var self = this;
	            if (event.QRScan) {
	                event.QRScan('yes', function (ret) {
	                    if (ret.result == '1') {
	                        var hCode = ret.hCode;
	                        if (hCode) {}
	                    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        dir: 'yjpt',
	        imgUrl: 'yjpt/images/yjpt_lb02.jpg'
	    }},
	    created: function created() {
	        this.imgUrl = Utils.changeImg(this.imgUrl);
	    }
	};}
	/* generated by weex-loader */
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/class-index', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "title": "幼教平台",
	    "titleColor": "white",
	    "leftItemSrc": function () {return this.leftItemImg}
	  },
	  "classList": [
	    "page_nav"
	  ],
