	            ...
	            },
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.redirect(this.forgetPwdUrl,$event)}
	                  },
	                  "attr": {
	                    "value": "忘记密码"
	                  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        this.forgetPwdUrl = base + this.forgetPwdUrl + '.js';
	    ...
	    methods: {
	        ...
	        loginHandle: function loginHandle() {
	            ...
	            var reqData = '';
	            if (this.code == '') {
	                reqData = 'userName=' + this.phoneNumber + '&password=' + this.pwd;
	            } else {
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    ...
	                    } else if (obj.retcode == '22') {
	                        self.loading = false;
	                        modal.alert({
	                            message: '验证码错误，请重新输入',
	                            okTitle: '好的'
	                        }, function () {
	                            self.imgUrl = self.imgUrl.split("?")[0] + '?' + Math.random().toString().split(".")[1];
	                        });
	                    } else if (obj.retcode == '33') {
	                        self.loading = false;
	                        modal.alert({
	                            message: '账户未激活，请联系客服激活',
	                            okTitle: '好的'
	                        }, function () {});
	                    }
	                },
