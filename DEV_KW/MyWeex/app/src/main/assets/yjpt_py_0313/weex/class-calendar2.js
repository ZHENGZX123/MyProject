...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/62c7b2e47d8c18f8fabe84469b6487fa', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/62c7b2e47d8c18f8fabe84469b6487fa',undefined,undefined)
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "repeat": function () {return this.lessonDirList},
	                      "events": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftItemImg', 'rightItemImg', 'rightArrow']);
	        ...
	        storage.getItem('gradeId', function (e) {
	            if (e.data != 'undefined') {
	                ...
	                self.loading = true;
	                Utils.fetch({
	                    url: '/lessonDir/searchDir',
	                    data: 'dirType=' + self.dirType + '&gradeId=' + self.gradeId,
	                    type: 'json',
	                    method: 'POST',
	                    success: function success(ret) {
	                        if (ret.data.retcode == '1') {
	                            ...
	                            self.lessonDirList = JSON.parse((0, _stringify2.default)(ret.data.lessonDirList));
	                            for (var i in self.lessonDirList) {
	                                self.setPhoto(i);
	                            }
	                        }
	                    },
	                ...
	                Utils.changeImg(self.lessonDirList, ['preview']);
	            }
	        });
	    },
	    methods: {
	        ...
	        redirect: function redirect(url, index) {
	            var self = this;
	            storage.setItem('dirId', self.lessonDirList[index].id, function () {});
	            storage.setItem('gradeId', self.lessonDirList[index].grade_id, function () {});
	            storage.setItem('libraryName', self.lessonDirList[index].name, function () {});
	            storage.setItem('idea', self.lessonDirList[index].idea, function () {});
	        ...
	        setPhoto: function setPhoto(i) {
	            var self = this;
	            self.lessonDirList[i].preview = self.dir + self.lessonDirList[i].preview;
	        }
