...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_bootstrap__('@weex-component/feb9ccc90ed937a81698003f3d5de54f',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "value": function () {return '还可以输入  ' + (this.countRemain) + '  个字'}
	          }
	        },
	        {
	          "type": "div",
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": function () {return this.addPhotos1}
	                  },
	                  "style": {
	                    "width": 140,
	                    "height": 140
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": function () {return this.addPhotos2}
	                  },
	                  "style": {
	                    "width": 140,
	                    "height": 140
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": function () {return this.addPhotos3}
	                  },
	                  "style": {
	                    "width": 140,
	                    "height": 140
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": function () {return this.addPhotos4}
	                  },
	                  "style": {
	                    "width": 140,
	                    "height": 140
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": function () {return this.addPhotos}
	                  },
	                  "style": {
	                    "width": 140,
	                    "height": 140
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return this.Whether}
	              }
	            },
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		created: function created() {
			...
			this.addPhotos1 = Utils.ip + 'yjpt/images/index_07.jpg';
			this.addPhotos2 = Utils.ip + 'yjpt/images/index_15.jpg';
			this.addPhotos3 = Utils.ip + 'yjpt/images/index_19.jpg';
			this.addPhotos4 = Utils.ip + 'yjpt/images/index_22.jpg';
			...
			storage.getItem('sfgk', function (e) {
				self.Whether = e.data;

				self.Whether = self.Whether == 1 || self.Whether == 'undefiend' ? '公开' : '不公开';
				console.log(self.Whether);
			});

			storage.getItem('content', function (e) {
				if (e.data != 'undefiend') {
					self.recordContent = e.data != 'undefined' ? e.data : '';
					self.countRemain = self.countRemain - self.recordContent.length;
				}
			});

			this.$on('naviBar.rightItem.click', function (e) {
				var whether = self.Whether == '公开' ? 1 : 2;
				Utils.fetch({
					url: '/growth/create',
					data: 'userId=' + userId + '&content=' + self.recordContent + '&ispublic=' + whether + '&childId=' + childId,
					type: 'json',
					method: 'POST',
		...
		methods: {
			recordCIn: function recordCIn(e) {
				this.recordContent = e.value;
				this.countRemain = this.numberCount - e.value.length;
				if (this.countRemain <= 0) {
					this.countRemain = 0;
					this.recordContent = e.value.substring(0, this.numberCount);
				}
			},
			opensfgkPage: function opensfgkPage() {
				this.$openURL(Utils.setOpenUrl(this.$getConfig(), 'wdxc_fbwz_sfgk'));
			}
		}
	};}
	/* generated by weex-loader */
