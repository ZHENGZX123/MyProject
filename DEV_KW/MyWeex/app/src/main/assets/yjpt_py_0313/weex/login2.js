...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/64482433a56dfcd2ce0923b989a02944', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/64482433a56dfcd2ce0923b989a02944',undefined,undefined)
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        openPage: function openPage() {
	            ...
	            var reqData = '';
	            if (this.verCode == '') {
	                reqData = 'userName=' + this.telphone + '&password=' + this.pwd;
	            } else {
	                reqData = 'userName=' + this.telphone + '&password=' + this.pwd + '&code=' + this.verCode;
	            }
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    ...
	                    if (obj.retcode == '1') {
	                        ...
	                        setTimeout(function () {
	                            self.$openURL(Utils.setOpenUrl(self.$getConfig(), 'index'));
	                        }, 1000);
