...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/219dbda7f8a5ba457ac7aa99c1e213e4', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/219dbda7f8a5ba457ac7aa99c1e213e4',undefined,undefined)
	              ...
	              "children": [
	                {
	                  "type": "div",
	                  "events": {
	                    "click": function ($event) {this.openNews(this.url,$event)}
	                  },
	                  "children": [
	                    {
	                      "type": "image",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        itemsList: [{
	            date: '7月15日',
	            courseTitle: '留学迈入“高质量时代”名校门槛将“水涨船高” ',
	            src: 'yjpt/images/index_04.jpg',

	            itemList: [{ title: '奇葩试题不过是个“脑筋急转弯”sfsdf ', pictureUrl: 'yjpt/images/wa712aogzqyvoevxacei.jpg', url: 'showcase/new-fashion/info-detail' }, { title: '掌握方法是关法是关键掌握握方法是关键"一带一路"… ', pictureUrl: 'yjpt/images/jzxt.jpg', url: 'showcase/new-fashion/info-detail' }]
	        }, {
	            date: '7月12日',
	            courseTitle: '好品德童谣《合作救松鼠宝宝》',
	            src: 'yjpt/images/index_22.jpg',

	            itemList: [{ title: '掌握方法是关法是关键掌握握方法是关键"一带一路"… ', pictureUrl: 'yjpt/images/jzxt.jpg', url: 'showcase/new-fashion/info-detail' }, { title: '掌握方法是关键掌握方法握方法是关键掌握方法是关键… ', pictureUrl: 'yjpt/images/klxx.jpg', url: 'showcase/new-fashion/info-detail' }, { title: '习近平今年首访中东三国绘一带一路 ', pictureUrl: 'yjpt/images/qzyd.jpg', url: 'showcase/new-fashion/info-detail' }]
	        }, {
	            date: '7月10日',
	            courseTitle: '好品德童谣《合作救松鼠宝宝》',
	            src: 'yjpt/images/index_20.jpg',

	            itemList: [{ title: '奇葩试题不过是个“脑筋急转弯” ', pictureUrl: 'yjpt/images/wa712aogzqyvoevxacei.jpg', url: 'showcase/new-fashion/info-detail' }, { title: '掌握方法是关法是关键掌握握方法是关键"一带一路"… ', pictureUrl: 'yjpt/images/jzxt.jpg', url: 'showcase/new-fashion/info-detail' }, { title: '掌握方法是关键掌握方法握方法是关键掌握方法是关键… ', pictureUrl: 'yjpt/images/klxx.jpg', url: 'showcase/new-fashion/info-detail' }, { title: '习近平今年首访中东三国绘一带一路 ', pictureUrl: 'yjpt/images/qzyd.jpg', url: 'showcase/new-fashion/info-detail' }]
	        }],
	        url: 'info-detail',
	        classId: ''
	    }},
	    created: function created() {
	        ...
	        storage.getItem('userId', function (e) {
	            Utils.fetch({
	                url: '/tjsp/news/js_list.jsp',
	                data: 'userId=' + e.data + '&classId=' + self.classId + '&isParent=2',
	                type: 'json',
	                method: 'POST',
	    ...
	    methods: {
	        openNews: function openNews(url) {
