	...
	module.exports = {
	  data: function () {return {
	    ...
	    tabItems: [{
	      ...
	      bgColor: '#fff',
	      icon: "",
	      image: "yjpt/images/home_1.png",
	      selectedImage: "yjpt/images/home.png",
	      src: "main.js",
	      visibility: "visible"
	    }, {
	      index: 1,
	      ...
	      bgColor: '#fff',
	      icon: "",
	      image: "yjpt/images/my.png",
	      selectedImage: "yjpt/images/my_01.png",
	      src: "mine.js",
	      visibility: "hidden"
	    }]
	  }},
	  created: function created() {
	    ...
	    Utils.changeImg(this.tabItems, ['image', 'selectedImage']);
	  },
	  methods: {
