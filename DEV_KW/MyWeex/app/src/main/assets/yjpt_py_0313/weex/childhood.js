...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/86324e9e551d69e3f6cac2d5e6437b16', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/86324e9e551d69e3f6cac2d5e6437b16',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        {
	          "type": "scroller",
	          "shown": function () {return this.currentTab==1},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "repeat": function () {return this.childhoodFM1},
	                      "style": {
	                        "backgroundColor": function () {return this.bgColor},
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "repeat": function () {return this.childhoodFM2},
	                      "style": {
	                        "backgroundColor": function () {return this.bgColor},
	                        "borderColor": function () {return this.borderColor}
	                      },
	        ...
	        {
	          "type": "scroller",
	          "shown": function () {return this.currentTab==2},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	              ...
	              "children": [
	                {
	                  ...
	                  "repeat": function () {return this.childhoodColumn},
	                  "events": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        dirType: '1',
	        gradeId: '',
	        childhoodFM: [{ name: '安胎', iconUrl: 'yjpt/images/baby.png', bgColor: '#e59345', borderColor: '#ffe9e9', url: 'class-attending' }, { name: '哄睡', iconUrl: 'yjpt/images/sleep.png', bgColor: '#99cC33', borderColor: '#ffe9e9', url: 'class-circle' }, { name: '叫醒', iconUrl: 'yjpt/images/wake_up.png', bgColor: '#2baaff', borderColor: '#cdf2e7', url: 'class-message' }, { name: '学唱', iconUrl: 'yjpt/images/singing.png', bgColor: '#99cC33', borderColor: '#a9ddff', url: 'student-record' }, { name: '玩耍', iconUrl: 'yjpt/images/fun.png', bgColor: '#2baaff', borderColor: '#dfdff4', url: 'student-info2' }, { name: '故事', iconUrl: 'yjpt/images/castle.png', bgColor: '#e59345', borderColor: '#ffede6', url: 'news' }],
	        childhoodColumn: [{ name: '每周精选', iconUrl: 'yjpt/images/5472600.jpg', url: 'childhood-list' }, { name: '每周精选', iconUrl: 'yjpt/images/5472600.jpg', url: 'childhood-list' }, { name: '每周精选', iconUrl: 'yjpt/images/5472600.jpg', url: 'childhood-list' }, { name: '每周精选', iconUrl: 'yjpt/images/5472600.jpg', url: 'childhood-list' }, { name: '每周精选', iconUrl: 'yjpt/images/5472600.jpg', url: 'childhood-list' }, { name: '每周精选', iconUrl: 'yjpt/images/5472600.jpg', url: 'childhood-list' }],
	        childhoodFM1: [],
	        childhoodFM2: []
	    }},
	    created: function created() {
	        ...
	        for (var i = 0; i < this.childhoodColumn.length; i++) {
	            var tabList = this.childhoodColumn[i];
	            tabList.url = base + tabList.url + '.js';
	        }

	        this.childhoodFM1 = this.childhoodFM.slice(0, 3);
	        this.childhoodFM2 = this.childhoodFM.slice(3, 6);
