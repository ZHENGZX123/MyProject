...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/95d5318ee7ca89246f2bd569d4b70d83', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/95d5318ee7ca89246f2bd569d4b70d83',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "placeholder": "说点什么",
	        "value": function () {return this.content.circle}
	      },
	      "events": {
	        "input": "circleIn"
	      }
	      ...
	      "children": [
	        {
	          ...
	          "repeat": function () {return this.content.images},
	          "shown": function () {return this.content.images.length>0},
	          "classList": [
	            "circle_img"
	          ]
	        },
	...
	module.exports = {
	    data: function () {return {
	        ...
	        images: {
	            ...
	            uploadImg: 'yjpt/images/plus2.png'
	        },
	        content: {
	            circle: '',
	            images: []
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftItemImg', 'uploadImg']);
	        ...
	        storage.setItem('circleContent', this.content);

	        this.$on("naviBar.rightItem.click", function () {

	            if (self.content.circle == '' && self.content.images.length <= 0) {
	                return;
	            }
	            storage.getItem('jsessionid', function (e) {
	                var jsessionid = e.data;
	                var images = self.content.images.length <= 0 ? [] : self.content.images;

	                var paramJson = {
	                    url: Utils.ip + '/classGroup/create',
	                    userId: self.userId,
	                    jsessionid: jsessionid,
	                    content: self.content.circle,
	    ...
	    methods: {
	        ...
	        circleIn: function circleIn(e) {
	            this.content.circle = e.value.replace(/\s/g, "");
	        },
