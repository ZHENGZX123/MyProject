...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/6c9ddcacd45c853dce9f7cdbc15ec4d7', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/6c9ddcacd45c853dce9f7cdbc15ec4d7',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "repeat": function () {return this.familyList},
	          "events": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        familyList: [{ Family: '爸爸', status: '', type: '1' }, { Family: '妈妈', status: '', type: '2' }, { Family: '亲戚', status: '', type: '3' }],
	        parentType: '1'
	    }},
	    created: function created() {
	        ...
	        storage.getItem('parentType', function (e) {
	            self.parentType = e.data;

	            for (var i in self.familyList) {
	                if (self.familyList[i].type == self.parentType) {
	                    self.familyList[i].status = self.images.selectRadio;
	                } else {
	                    self.familyList[i].status = self.images.blankRadio;
	                }
	            }
	        });
	        ...
	        for (var i in this.familyList) {
	            this.familyList[i].status = this.images.blankRadio;
	            this.familyList[0].status = this.images.selectRadio;
	        }
	        this.$on('naviBar.rightItem.click', function (e) {
	            console.log(self.parentType);
	            storage.setItem('parentType', self.parentType, function (e) {});
	    ...
	    methods: {
	        radioCheck: function radioCheck(index) {
	            var self = this;
	            for (var i in this.familyList) {
	                if (i == index) this.familyList[i].status = this.images.selectRadio;else this.familyList[i].status = this.images.blankRadio;
	            }
	            if (index == 0) {
	                self.parentType = '1';
	            } else if (index == 1) {
