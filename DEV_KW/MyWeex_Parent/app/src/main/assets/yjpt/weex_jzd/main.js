	  ...
	  methods: {
	    openTypePage: function openTypePage(url) {
	      if (url.indexOf('index_zjpd') == -1) {
	        if (url.indexOf('teaching') != -1) {
	          if (event.teaching) {
	            storage.getItem('jsessionid', function (e) {
	              event.teaching(e.data);
	            });
	          }
	        } else {
	    ...
	    chooseClass: function chooseClass() {}
	  }
	};}
	/* generated by weex-loader */
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/img-item-inside', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        menuList: [{ pictureUrl: 'yjpt/images/pic_zt01.png', title: '我要上课', url: 'teaching' }, { pictureUrl: 'yjpt/images/pic_zt02.png', title: '早教频道', url: 'index_zjpd' }, { pictureUrl: 'yjpt/images/pic_zt03.png', title: '照片发布', url: 'wdxc_fbwz' }],
	        dataList: [{ title: '小一班班群', pictureUrl: 'yjpt/images/Photo_04.png', state: 5, news_content: '你家孩子最近上课开小差', date: '07/01', size: 1, url: 'chat-item', classId: '{{classId}}' }, { title: '小一班班群', pictureUrl: 'yjpt/images/Photo_04.png', state: 5, news_content: '你家孩子最近上课开小差', date: '07/01', size: 1, url: 'chat-item', classId: '{{classId}}' }, { title: '小一班班群', pictureUrl: 'yjpt/images/Photo_04.png', state: 5, news_content: '你家孩子最近上课开小差', date: '07/01', size: 1, url: 'chat-item', classId: '{{classId}}' }, { title: '小一班讨论组', pictureUrl: 'yjpt/images/Photo_05.png', state: 5, news_content: '明天带两个孩子出去', date: '01/11', size: 1, url: 'chat-item', classId: '{{classId}}' }],
	    ...
	    created: function created() {
	        ...
	        this.bjUrl = Utils.ip + Utils.dir + '/' + 'yjpt/images/Photo_bj.png';

	        this.picAdd = Utils.ip + Utils.dir + '/' + 'yjpt/images/add.png';

	        for (var i = 0; i < this.menuList.length; i++) {
	            this.menuList[i].pictureUrl = Utils.ip + Utils.dir + '/' + this.menuList[i].pictureUrl;
	        }
	    ...
	    methods: {
	        ...
	        goProfile: function goProfile(url) {
	            var self = this;
	            Utils.navigate.push(self, url, 'true');
	        },
	                        ...
	                        Utils.fetch({
	                            ...
	                            success: function success(ret) {
	                                if (ret.data.StatusCode == '200') {
	                                    ...
	                                    storage.setItem('classInfo', (0, _stringify2.default)(classInfo), function () {});
