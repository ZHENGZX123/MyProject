...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/09f6bd3852eb7cac31f74e414533d6a3', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/09f6bd3852eb7cac31f74e414533d6a3',undefined,undefined)
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        regHandle: function regHandle() {
	            ...
	            Utils.fetch({
	                url: '/user/uppw',
	                data: 'phone=' + this.phoneNum + '&password=' + this.pwd + '&vm=' + this.verCode + '&type=2',
	                method: 'POST',
	                dataType: 'json',
