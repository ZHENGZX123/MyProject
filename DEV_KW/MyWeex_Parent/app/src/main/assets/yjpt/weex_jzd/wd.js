...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/d6166d7e7dbd022f322adb65abe333d9', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/d6166d7e7dbd022f322adb65abe333d9',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "rightItemSrc": function () {return this.headRight}
	  },
	  "events": {
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "repeat": function () {return this.studentList},
	          "events": {
	            "click": function ($event) {this.gotoPage(this.$index,$event)}
	          },
	          "shown": function () {return this.studentList.length>0},
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.avatar?this.avatar:this.myPortraitUrl}
	                  }
	                },
	                {
	                  "type": "text",
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.images.arrows}
	                  },
	                  "style": {
	                    "width": 22,
	                    "height": 35
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        self.headRight = Utils.ip + Utils.dir + '/' + 'yjpt/images/yjptj_ic_social_person_add.png';

	        Utils.changeImg(self.images, ['classImg', 'arrows', 'mineImg']);
	        ...
	        var babyList = new BroadcastChannel('unBindChild');
	        babyList.onmessage = function (event) {
	            for (var i in self.studentList) {
	                if (self.studentList[i].userId == event.data) {
	                    self.studentList.splice(i, 1);
	                }
	            }
	        };
	    ...
	    methods: {
	        openWoPage: function openWoPage() {
	            var url = Utils.setOpenUrl(this.$getConfig(), 'wo');
	            Utils.navigate.push(this, url, 'true');
	        },
	        openSetUpPage: function openSetUpPage() {
	            var url = Utils.setOpenUrl(this.$getConfig(), 'wd_sz');
	            Utils.navigate.push(this, url, 'true');
	        },
	        gotoPage: function gotoPage(index) {
	            ...
	            for (var i in self.myClass) {
	                if (self.studentList[index].classId == self.myClass[i].id) {
	                    storage.setItem('className', self.myClass[i].name, function () {});
	                    storage.setItem('classInfo', (0, _stringify2.default)(self.myClass[i]), function () {});
	                }
	            }

	            storage.setItem('myBaby', (0, _stringify2.default)(self.studentList[index]), function () {});

	            storage.removeItem('bindRelation', function () {});

	            var url = Utils.setOpenUrl(self.$getConfig(), 'wd_bb');
	            Utils.navigate.push(self, url, 'true');
	        }
	    }
	};}
