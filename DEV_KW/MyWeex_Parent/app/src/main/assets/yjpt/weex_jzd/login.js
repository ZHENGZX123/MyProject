...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/c0317ed76cca5fb5ef215eb814989407', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/c0317ed76cca5fb5ef215eb814989407',undefined,undefined)
	...
	module.exports = {
	  ...
	  "children": [
	          ...
	          "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.phoneImg}
	                  }
	                }
	              ]
	            },
	            {
	              ...
	              "attr": {
	                "type": "number",
	                "placeholder": "请输入手机号",
	                "value": function () {return this.telphone}
	              },
	              "id": "telPhone",
	              "events": {
	                "input": "numTypeIn"
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.pwdImg}
	                  }
	                }
	              ]
	            },
	    ...
	    },
	    {
	      ...
	      "shown": function () {return this.loginFailTime>=3},
	      "children": [
	        {
	          "type": "div",
	          "classList": [
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return this.verCode},
	                "placeholder": "请输验证码"
	              }
	            },
	            {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        pwdIn: function pwdIn(e) {
	            this.pwd = e.value;
	        },
	        CodeIn: function CodeIn(e) {
	            this.verCode = e.value;
	        },
	        openPage: function openPage() {
	            var self = this;
	            if (self.telphoneCheck == false) {
	                modal.alert({
	            ...
	            var reqData = '';
	            if (this.verCode == '') {
	                reqData = 'userName=' + this.telphone + '&password=' + this.pwd + '&userType=2';
	            } else {
	                reqData = 'userName=' + this.telphone + '&password=' + this.pwd + '&code=' + this.verCode + '&userType=2';
	            }
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    ...
	                    if (ret.data.StatusCode == '200') {
	                        ...
	                        self.userId = ret.data.data;
	                        storage.setItem('userId', self.userId, function () {});
	                            ...
	                            success: function success(res) {
	                                if (res.data.StatusCode == '200') {
	                                    ...
	                                    for (var i in self.classMap) {
	                                        myClass.push(self.classMap[i]);
	                                    }

	                                    for (var i in myClass) {
	                                        myClass[i].imgUrl = '';
	                                        myClass[i].borderWidth = '2px';
	                                        myClass[i].borderStyle = 'solid';
	                                        myClass[i].borderColor = '#e7e7e7';
	                                        myClass[i].color = '#000000';
	                                    }

	                                    storage.setItem('myClass', (0, _stringify2.default)(myClass), function () {});
	                    ...
	                    } else if (ret.data.StatusCode == '404') {
	                        modal.toast({
	                            message: '账号或密码错误',
	                            duration: '0.5'
	                        });
	        ...
	        forgetPsPage: function forgetPsPage() {
