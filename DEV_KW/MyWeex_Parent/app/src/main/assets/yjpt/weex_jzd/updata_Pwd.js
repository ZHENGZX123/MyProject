...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/cafc032f7f0d446b57a03266dfaf94b6', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/cafc032f7f0d446b57a03266dfaf94b6',undefined,undefined)
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "type": "password",
	                "placeholder": "请输入旧密码",
	                "value": function () {return this.oldPwd}
	              },
	              "events": {
	                "input": "jPwdIn"
	              }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        jPwdIn: function jPwdIn(e) {
	            this.oldPwd = e.value;

	            var Pwd;
	            storage.getItem('Pwd', function (e) {
	                Pwd = e.data;
	                if (/\S{6,}/.test(this.oldPwd) == Pwd) {
	                    this.oldPwdCheck = true;
	                    console.log("旧密码" + this.oldPwdCheck);
	                } else {
	        ...
	        openPage: function openPage() {
	            ...
	            Utils.fetch({
	                url: '/user/uppwLogin',
	                data: 'oldPassword=' + self.oldPwd + '&newPassword=' + self.pwd,
	                method: 'POST',
	                dataType: 'json',
