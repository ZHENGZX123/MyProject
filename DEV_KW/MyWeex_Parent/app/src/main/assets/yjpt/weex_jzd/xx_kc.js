...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/91abb54f761cf611823383ee86b7d54d', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/91abb54f761cf611823383ee86b7d54d',undefined,undefined)
	                  ...
	                  "children": [
	                    {
	                      "type": "text",
	                      "attr": {
	                        "value": function () {return (this.courseTime) + '分钟'}
	                      }
	                    },
	                    {
	                      "type": "div",
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.courseExplain}
	                      }
	                    },
	                    {
	                      "type": "image",
	                      ...
	                      "events": {
	                        "click": function ($event) {this.openVideo(this.lessonId,$event)}
	                      }
	                    }
	                  ]
	                }
	...
	module.exports = {
	  data: function () {return {
	    ...
	    storage.getItem('classId', function (e) {
	      ...
	      var date = year + '-' + month;
	      Utils.fetch({
	        url: '/lesson/getAttendedLesson',
	        data: 'classId=' + self.classId + '&minDate=' + date,
	        method: 'POST',
	        dataType: 'json',
	        success: function success(ret) {
	          var itemList = ret.data;
	          var arr = [];
	          for (var i in itemList.lessonList) {
	            var obj = itemList.lessonList[i];

	            var date = new Date(obj.finishDate.replace(/\-/g, '/'));
	            var year = date.getFullYear();
	            var month = date.getMonth() + 1;
	            var date1 = date.getDate();
	            var finishDate = month + "月" + date1 + "日";
	            var data = {
	              date: finishDate,
	              courseTime: obj.requireTime.replace(/\-/g, '/'),
	              courseTitle: obj.lessonName,
	              courseExplain: obj.teachingAim,
	              videoSrc: Utils.ip + 'yjpt' + obj.preview,
	  ...
	  methods: {
	    openVideo: function openVideo(lessonId) {
	      storage.setItem('lessonId', lessonId, function (e) {});
	      var url = Utils.setOpenUrl(this.$getConfig(), 'video');
