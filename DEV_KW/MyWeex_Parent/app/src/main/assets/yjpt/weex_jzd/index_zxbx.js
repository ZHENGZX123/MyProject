...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/6c630d9eff7bd2c75c6089422ebe0481', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/6c630d9eff7bd2c75c6089422ebe0481',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/wxc-schoolperday', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.pic_yx}
	                  }
	                },
	                {
	                  "type": "text",
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.pic_bc}
	                  }
	                },
	                {
	                  "type": "text",
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.pic_xrl}
	                  }
	                },
	                {
	                  "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	   ...
	   created: function created() {
	      var self = this;
	      this.pic_yx = Utils.ip + 'yjpt/images/pic_yx.png';
	      this.pic_bc = Utils.ip + 'yjpt/images/pic_bc.png';
	      this.pic_xrl = Utils.ip + 'yjpt/images/pic_xrl.png';
	      this.default = Utils.ip + 'yjpt/images/default.png';
	      Utils.setOpenUrl(this.$getConfig(), this.itemList);
	      Utils.changeImg(this.itemList, ['typePic1', 'typePic2', 'typePic3', 'typePic4', 'typePic5', 'typePic6']);
	      ...
	      storage.getItem('childId', function (e) {
	         ...
	         Utils.fetch({
	            url: '/performance/childSP',
	            data: 'childId=' + childId + '&minDate=' + date,
	            method: 'POST',
	            dataType: 'json',
	            success: function success(ret) {
	               var itemList = ret.data;
	               Utils.fetch({
	                  ...
	                  success: function success(ret) {
	                     ...
	                     var childID;
	                     var arr = [];
	                     for (var i in userInfo.childsInfo) {
	                        var objs = userInfo.childsInfo[i];
	                        childID = objs.childId;

	                        if (childId == childID) {
	                           var performanceImg = function performanceImg(val) {
	                              var ret;
	                              switch (val) {
	                                 case '1':
	                                    ret = Utils.ip + 'yjpt/images/pic_yx.png';break;
	                                 case '2':
	                                    ret = Utils.ip + 'yjpt/images/pic_bc.png';break;
	                                 case '3':
	                                    ret = Utils.ip + 'yjpt/images/pic_xrl.png';break;
	                              }
	                              return ret;
	                           };

	                           for (var i in itemList.SPList) {
	                              var obj = itemList.SPList[i];
	                              var data = {
	                                 name: objs.childName,
	                                 date: obj.date,
	                                 class: objs.className,
	                                 typePic1: performanceImg(obj['1']),
	                                 typePic2: performanceImg(obj['2']),
	                                 typePic3: performanceImg(obj['3']),
	                                 typePic4: performanceImg(obj['4']),
	                                 typePic5: performanceImg(obj['5']),
	                                 typePic6: performanceImg(obj['6'])
	                              };
	                              arr.push(data);
	                           }
	                           self.itemList = arr;
