...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/6ebfb9d0b99f656a7368505c3a551fc0', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/6ebfb9d0b99f656a7368505c3a551fc0',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "value": function () {return this.mysub}
	          }
	        },
	        {
	          "type": "text",
	          ...
	          "attr": {
	            "src": function () {return this.src},
	            "value": function () {return this.revise}
	          },
	          "events": {
	            "click": "openPage"
	          }
	      ...
	      "children": [
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.opensubPage(this.url,$event)}
	          },
	          "repeat": function () {return this.suberList},
	          "children": [
	            {
	              "type": "image",
	              "classList": [
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "value": function () {return this.pare}
	          }
	        },
	        {
	          "type": "text",
	          ...
	          "attr": {
	            "src": function () {return this.src},
	            "value": function () {return this.barter}
	          }
	        }
	      ]
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    ...
	    revise: '修改',
	    barter: '换一换',
	    subList: [{ title: '积分入学', pictureUrl: 'yjpt/images/qzyd.jpg', news_content: '学校这次活动是什…', value: '已订阅', url: 'sub-center' }, { title: '幼升小', pictureUrl: 'yjpt/images/ysx.jpg', news_content: '欢迎使用亲子趣！玩，是最', value: '订阅', url: 'sub-type' }, { title: '小升初 ', pictureUrl: 'yjpt/images/xsc.jpg', news_content: '欢迎使用亲子趣！玩，是最', value: '订阅', url: 'sub-type' }],
	    suberList: [{ title: '积分入学', pictureUrl: 'yjpt/images/qzyd.jpg', url: 'sub-type' }, { title: '家长学堂', pictureUrl: 'yjpt/images/jzxt.jpg', url: 'sub-type' }, { title: '积分入学', pictureUrl: 'yjpt/images/qzyd.jpg', url: 'sub-type' }]
	  }},
	  created: function created() {
	    Utils.setOpenUrl(this.$getConfig(), this.subList);
	    Utils.setOpenUrl(this.$getConfig(), this.suberList);
	    Utils.changeImg(this.subList, ['pictureUrl']);
	    Utils.changeImg(this.suberList, ['pictureUrl']);
	  },
	  methods: {
	    openPage: function openPage() {
	      var url = Utils.setOpenUrl(this.$getConfig(), 'sub-center');
	      Utils.navigate.push(this, url, 'true');
	    },
	    opensubPage: function opensubPage(url) {
	      Utils.navigate.push(this, url);
	    }
	  }
	};}
