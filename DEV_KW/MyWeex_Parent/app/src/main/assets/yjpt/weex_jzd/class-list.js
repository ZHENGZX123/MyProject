	      ...
	      "children": [
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.gotoMembers(this.id,this.name,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    }, (0, _defineProperty3.default)(_data, 'myClass', []), (0, _defineProperty3.default)(_data, 'classMembers', []), (0, _defineProperty3.default)(_data, 'classMemberUrl', 'class-members'), (0, _defineProperty3.default)(_data, 'studentList', []), _data),
	    created: function created() {
	    ...
	    methods: {
	        gotoMembers: function gotoMembers(classId, className) {
	            var self = this;
	            ...
	            Utils.fetch({
	                ...
	                success: function success(res) {
	                    ...
	                    if (result.StatusCode == '200') {
	                        self.classMembers = result.data.studentList;
	                        for (var i in self.classMembers) {
	                            self.classMembers[i].imgUrl = self.images.blankRadio;
	                            self.classMembers[i].isBinding = 'no';

	                            for (var j in self.studentList) {
	                                if (self.studentList[j].userId == self.classMembers[i].id) {
	                                    self.classMembers[i].isBinding = 'yes';
	                                }
	                            }
	                        }

	                        storage.setItem('classId', classId, function () {});
	                        storage.setItem('classMembers', (0, _stringify2.default)(self.classMembers), function () {});
