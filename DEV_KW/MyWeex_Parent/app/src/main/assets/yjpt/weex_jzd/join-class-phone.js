...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/0080a5b22bb05dbb15b8f16a3f71a9f8', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/0080a5b22bb05dbb15b8f16a3f71a9f8',undefined,undefined)
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                ...
	                "value": function () {return this.teachersPhone}
	              },
	              "id": "work_title",
	              "events": {
	                "input": "phoneIn"
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        self.$on('naviBar.rightItem.click', function (e) {
	            if (!/^1[3|4|5|7|8]\d{9}$/.test(self.teachersPhone) || self.teachersPhone == "") {
	                modal.toast({
	                    message: '请输入正确的手机号码',
	                    duration: '0.5'
	                });
	            ...
	            Utils.fetch({
	                url: '/app/class/phone/' + self.teachersPhone,
	                dataType: 'json',
	                method: 'get',
	                success: function success(res) {
	                    if (res.data) {
	                        if (res.data.StatusCode == '200') {
	                            ...
	                            var url = Utils.setOpenUrl(self.$getConfig(), 'class-list');
	    ...
	    methods: {
	        phoneIn: function phoneIn(e) {
	            var self = this;
	            self.teachersPhone = e.value;
	        }
	    }
	};}
	/* generated by weex-loader */
