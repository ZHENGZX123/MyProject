	            ...
	            },
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "shown": function () {return !this.mac},
	                  "events": {
	                    "click": function ($event) {this.scanToClass(this.id,$event)}
	                  },
	                  "attr": {
	                    "value": "扫码上课"
	                  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        redirect: function redirect(url, classId) {
	            var self = this;

	            storage.setItem('classId', classId, function () {});

	            var url = Utils.setOpenUrl(this.$getConfig(), 'class-calendar');
	            Utils.navigate.push(this, url, 'true');
	        },
	        scanToClass: function scanToClass(classId) {
	            var self = this;
	            if (event.QRScan) {
	                event.QRScan({
	                    classId: classId
