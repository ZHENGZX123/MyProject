...
public class LFilePicker {
     ...
     * @return
     */
    public LFilePicker withfilePath(String filePath) {
    ...
    public void start() {
        if (mActivity == null && mFragment == null && mSupportFragment == null) {
            throw new RuntimeException("You must pass Activity or Fragment by withActivity or withFragment or " +
                    "withSupportFragment method");
        }
    ...
    private Bundle getBundle() {
        ...
        paramEntity.setFilePath(filePath);
