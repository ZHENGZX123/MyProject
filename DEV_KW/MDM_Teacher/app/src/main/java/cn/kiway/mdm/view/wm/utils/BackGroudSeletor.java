package cn.kiway.mdm.view.wm.utils;
...
public class BackGroudSeletor {
     ...
     * @param context   上下文
     */
    public static StateListDrawable createBgByImagedrawble(int[] imagename,
                                                           Context context) {
...
//			}
     ...
     * @return 可用的Drawable
     */
    public static Drawable getdrawble(int id, Context context) {
