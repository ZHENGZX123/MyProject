...
import io.agora.rtc.ss.app.WhiteboardActivity1;
import io.agora.rtc.ss.app.WhiteboardActivity2;
...
public class ScreenSharingActivity extends BaseActivity {
    ...
    public void initModules() {
        ...
        if (mRtcEngine == null) {
            try {
                mRtcEngine = RtcEngine.create(getApplicationContext(), getString(io.agora.rtc.ss.app.R.string.agora_app_id), new IRtcEngineEventHandler() {
                    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.agora.rtc.ss.app.R.layout.activity_hello_agora_screen_sharing);
    ...
    public void onLiveSharingScreenClicked(View view) {
        ...
        if (button.isSelected()) {
            ...
            button.setText(io.agora.rtc.ss.app.R.string.label_stop_sharing_your_screen);
            ...
            TextView tv = (TextView) findViewById(io.agora.rtc.ss.app.R.id.channel_name_info);
            tv.setText(io.agora.rtc.ss.app.R.string.label_hello_agora);

            button.setText(io.agora.rtc.ss.app.R.string.label_start_sharing_your_screen);
    ...
    public void whiteborad2(View view) {
        startActivity(new Intent(this, WhiteboardActivity2.class));
    }
