...
public final class KwConnector extends Thread {
    protected final AtomicInteger size = new AtomicInteger(0);
    private final Selector selector;
    private final KwReactorGroup reactor;
    private final Queue<KwConnection> queue = new ConcurrentLinkedQueue<KwConnection>();

    public KwConnector(int reactorThreads) throws IOException {
        this.selector = Selector.open();
        this.reactor = new KwReactorGroup(reactorThreads);
    }
    ...
    private void register(KwConnection conn) {
        queue.offer(conn);
        selector.wakeup();
    }
    ...
    public final void create(String uri, KwConnectionHandler handler, boolean keepAlive, boolean noDelay) throws IOException {
        try {
            ...
            KwConnection conn = new KwConnection(channel, handler, address);
