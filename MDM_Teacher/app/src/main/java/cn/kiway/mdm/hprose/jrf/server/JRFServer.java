...
public class JRFServer extends Thread {
	...
	public static boolean shareFile(String file){
		if(file.startsWith("."))return false;
		files.put(file, System.currentTimeMillis());
		return true;
	}
	public static boolean isShareFile(String file){
	...
	private static String sharedir="/tmp/";
	public static String setSharedir(String dir) {
		JRFServer.sharedir = dir;
		return sharedir;
	}
