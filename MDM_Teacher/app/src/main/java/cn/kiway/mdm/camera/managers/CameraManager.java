package cn.kiway.mdm.camera.managers;
...
import cn.kiway.mdm.camera.listeners.ZoomListener;
...
//            Log.e("---------",pictureSizeList.toString());
//            /* 从列表中选取合适的分辨率 */
//            Size picSize = getProperSize4Ratio(pictureSizeList, (float) mSurfaceview.getHeight() / mSurfaceview.getWidth());
//
...
//                Size videoSize = getMaxSize4Width(videoSiezes, mSurfaceview.getWidth());
...
//            Size previewSize = getProperSize4Ratio(previewSizes, (float) videoWidth / videoHeight);
