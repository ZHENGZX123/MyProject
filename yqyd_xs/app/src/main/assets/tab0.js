    ...
    stream.fetch({
      ...
      if (!response.ok || response.ok == 0) {
        ...
        if (options.success && typeof options.success == 'function') {
          ...
          if (data.status && data.status == 409 || data.statusCode && data.statusCode == 409) {
            ...
            storage.getItem('username', function (data) {
              ...
              Utils.getAccessToken(params, self, function (ret) {
                Utils.fetch({
                  url: options.url,
                  method: options.method || method,
                  type: 'json',
            ...
            return;
          } else if (data.status && data.status == 408 || data.statusCode && data.statusCode == 408) {
            modal.alert({
	...
	methods: {
		...
		optType: function optType(id, name) {
			...
			for (var i in self.typeList) {
				...
				if (i == arguments[2]) {
					self.typeList[arguments[2]].bj = '#d9e8fd';
					self.typeList[arguments[2]].color = "#6fa1e8";
				}
			}
			this.msg = '';
		...
		storage.getItem('username', function (e) {
			...
			_Utils2.default.fetch({
				...
				success: function success(ret) {
					console.log(ret);
					if (ret.data.status == 200) {
						console.log(ret.data.result.rank);
		...
		_end: function _end() {
			...
			if (self.type == 2) {
				...
				_Utils2.default.fetch({
					...
					success: function success(ret) {
						if (ret.data.status == 200) {
							self.$router.push('/ydrw/cgjg?zq=' + self.yCount + '&lx=2' + '&cw=' + self.nCount + '&zql=' + parseInt(self.yCount / self.length * 100) + '&pid=' + self.$route.query.pid + '&bid=' + self.$route.query.bid + '&bname=' + self.bName);
						}
					}
				});
			} else {
...
exports.default = {
	...
	created: function created() {
		...
		console.log('ssssssssssssssss', self.$route.query.bookId, self.$route.query.type);
		storage.getItem('username', function (e) {
			//从缓存中取userId
			self.loginA = e.data;
			_Utils2.default.fetch({
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("完成练习")]) : _vm._e(), (_vm.lx == 2) ? _c('text', {
    staticStyle: {
      fontSize: "36px",
      color: "#666"
    }
  ...
  }, [_vm._v("我的闯关")])]) : _vm._e(), (_vm.lx == 2) ? _c('div', {
    staticClass: ["footes_btn"],
    on: {
      "click": function($event) {
        _vm._goto("/ydrw")
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["top_name"]
  }, [_vm._v("阅读任务详情")])]), _c('scroller', [_c('div', {
    staticClass: ["b_name"]
  }, [_c('text', {
    staticClass: ["b_name1"]
  ...
  }, [_vm._v("我的读后感")]) : _vm._e(), (_vm.cg) ? _c('text', {
    staticClass: ["footes_btn"],
    on: {
      "click": function($event) {
        _vm.jump('/ydrw/wdcg?bid=' + _vm.bId + '&bname=' + _vm.bName + '&pid=' + _vm.rwId + '&cxl=' + 1)
      }
    }
  }, [_vm._v("我的闯关")]) : _vm._e()])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.info))])]) : _vm._e(), (_vm.kstfb_list.length >= 8 && _vm.nextPage) ? _c('loading', {
    staticClass: ["loading"],
    attrs: {
  ...
  }, [_c('scroller', _vm._l((_vm.typeList), function(type, i) {
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          _vm.optType(type.id, type.name, i)
        }
      }
    }, [_c('text', {
      staticStyle: {
  ...
  }, [_c('scroller', _vm._l((_vm.stateList), function(type, i) {
    return _c('div', {
      staticClass: ["s_class_opt"],
      style: {
        backgroundColor: type.bj,
      ...
      on: {
        "click": function($event) {
          _vm.optState(type.id, type.name, i)
        }
      }
    }, [_c('text', {
      staticStyle: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    return _c('div', {
      ...
      staticClass: ["rw_title"]
    }, [_vm._v("每日一练：" + _vm._s(rw.title))]) : _vm._e(), _c('text', {
      staticClass: ["rwType"],
      staticStyle: {
        marginTop: "10px"
      }
