...
Utils.getAccessToken = function (params, self, callback) {
  ...
  Utils.fetch({
    ...
    success: function success(ret) {
      ...
      console.log('utils......' + self.$store.state.token);
...
exports.default = new _vueRouter2.default({
  ...
  // 阅读任务 每日一练
  { path: '/wdrw_mryl', name: 'wdrw_mryl', component: __webpack_require__(20) },
  ...
  // 书香榜
  { path: '/sxb', name: 'sxb', component: __webpack_require__(19) },
  // // 阅读资讯
...
exports.default = {
	...
	/*beforeDestroy(){
 	this.willShow=false;
 	this.willShow2=false;
 	modal.alert({message: this.willShow })
 	modal.alert({message: this.willShow2 })
 },*/
	filters: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: ["indicator"]
  }, [_vm._v("加载更多 ...")])])], 1), (_vm.willShow) ? _c('div', {
    staticClass: ["s_class"],
    staticStyle: {
      left: "0px",
      height: "260px"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("加载更多 ...")])])], 1), (_vm.willShow2) ? _c('div', {
    staticClass: ["s_class"],
    staticStyle: {
      height: "260px"
    }
