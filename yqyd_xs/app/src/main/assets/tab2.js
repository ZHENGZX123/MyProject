...
exports.default = new _vueRouter2.default({
  ...
  /*----------------main begin---------------*/
  // 个人首页
  { path: '/mine', name: 'main', component: __webpack_require__(15) },
  // 消息中心
  { path: '/main/wdxx', name: 'wdxx', component: __webpack_require__(21) },

  // 我的分享
  { path: '/main/wdfx', name: 'wdfx', component: __webpack_require__(19) },
  // 我的收藏
  { path: '/main/wdsc', name: 'wdsc', component: __webpack_require__(20) },

  // 设置
  { path: '/main/sz', name: 'sz', component: __webpack_require__(18) },
  // 个人信息
  { path: '/main/grxx', name: 'grxx', component: __webpack_require__(16) },
  // 修改密码
  { path: '/main/xgmm', name: 'xgmm', component: __webpack_require__(22) },

  // 关于
  { path: '/main/main_gy', name: 'main_gy', component: __webpack_require__(17) }
...
exports.default = {
	data: function data() {
		...
		return _ref = {
			...
			qq: '',
			email: ''
		}, _defineProperty(_ref, 'sex', ''), _defineProperty(_ref, 'schoolName', ''), _defineProperty(_ref, 'Img', ''), _defineProperty(_ref, 'disabled', false), _defineProperty(_ref, 'stateList', [{ name: '男', bj: '', color: '#666', id: 0 }, { name: '女', bj: '', color: '#666', id: 1 }]), _defineProperty(_ref, 'imgUrl', ''), _defineProperty(_ref, 'loginA', ''), _defineProperty(_ref, 'text', ''), _ref;
	},
	...
	methods: {
		...
		onblur: function onblur(event) {
			// modal.toast({message: this.email,duration: 0.3})
		...
		onblur2: function onblur2(event) {
			// modal.toast({message: this.qq,duration: 0.3})
			var reg = /^[1-9][0-9]{4,9}$/;
			if (!reg.test(this.qq)) {
				this.text = 'qq格式错误';
				modal.alert({
		...
		onblur1: function onblur1(event) {
			// console.log('onblur:', event.value);
			// modal.toast({message: this.phone,duration: 0.3})
			var reg = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/; //手机号码
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("修改密码")]), _vm._m(0)]), _vm._m(1), _c('div', {
    staticClass: ["del"],
    on: {
      "click": _vm.gy
    }
