...
exports.default = {
	data: function data() {
		...
		return _ref = {
			...
			qq: '',
			email: ''
		}, _defineProperty(_ref, 'sex', ''), _defineProperty(_ref, 'schoolName', ''), _defineProperty(_ref, 'Img', ''), _defineProperty(_ref, 'disabled', false), _defineProperty(_ref, 'stateList', [{ name: '男', bj: '', color: '#666', id: 0 }, { name: '女', bj: '', color: '#666', id: 1 }]), _defineProperty(_ref, 'imgUrl', ''), _defineProperty(_ref, 'loginA', ''), _ref;
	},
