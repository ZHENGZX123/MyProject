...
exports.default = new _vueRouter2.default({
  // mode: 'abstract',
  routes: [{ path: '/', name: 'login', component: __webpack_require__(16) }, { path: '/wjmm', name: 'wjmm', component: __webpack_require__(15) }]
...
__vue_options__.__file = "F:\\weex-yqyd_sx0419\\weex-yqyd_sx0421\\src\\components\\login.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2696644e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
