...
public class ViewUtil {
	 ...
	 *            结束位置
	 */
	public static void setTextFontColor(BaseActivity activity, int id, Resources resources,
			int corlor, int st, int end) throws Exception {
		TextView view=ViewUtil.findViewById(activity,id);
...
//		switch (sex) {
//		case 0:
//			setArroundDrawable(view, R.drawable.yjpty_boy, -1, -1, -1);
//			setContent(view, R.string.boy);
//			break;
//
//		case 1:
//			setArroundDrawable(view, R.drawable.yjpty_gril, -1, -1, -1);
//			setContent(view, R.string.gril);
//			break;
//		default:
//			setArroundDrawable(view, R.drawable.yjpty_sex, -1, -1, -1);
