...
public class Config {
    ...
    final static public String[] SNS_OBJECT_EXT_TIME_FIELDS = {"fpL", "fpL"};
    ...
    static public String SNS_OBJECT_EXT_TIME_FIELD;
...
//        }
    ...
    static private void setConstants(int index) {
        ...
        SNS_OBJECT_EXT_TIME_FIELD = SNS_OBJECT_EXT_TIME_FIELDS[index];
