...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/29ff7707db21e91902f5fb39af14c23d', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/29ff7707db21e91902f5fb39af14c23d',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "src": function () {return this.myPortraitUrl}
	          },
	          "events": {
	            "click": "QRScan"
	          }
	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "value": function () {return this.family}
	          }
	        },
	        {
	          "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        storage.getItem('sex', function (e) {
	            self.sex = e.data != 'undefined' ? e.data : '';
	            self.sex = self.sex == 1 ? '男' : '女';
	        });

	        storage.getItem('birthday', function (e) {
	            self.date = e.data != 'undefined' ? e.data : '请填写宝贝生日';
	        });

	        storage.getItem('parentType', function (e) {
	            self.family = e.data;
	            if (self.family == '1') {
	                self.family = "爸爸";
	    ...
	    methods: {
	        openPage: function openPage() {
	            ...
	            if (self.family == '爸爸') {
	                parentType = 1;
	            } else if (self.family == '妈妈') {
	                parentType = 2;
	            } else {
	                parentType = 3;
	            }
	            Utils.fetch({
	                url: '/yjpclass/QRCClass/parent',
	                data: 'userId=' + self.userId + '&childId=' + self.childId + '&classId=' + self.classId + '&parentType=' + parentType,
	                type: 'json',
	                method: 'POST',
	        ...
	        openDatePage: function openDatePage() {
	            var url = Utils.setOpenUrl(this.$getConfig(), 'birthday');
	            Utils.navigate.push(this, url, 'true');
	        },
	        openSexPage: function openSexPage() {
	            var url = Utils.setOpenUrl(this.$getConfig(), 'childs-sex');
	            Utils.navigate.push(this, url, 'true');
	        },
	        openfamilyPage: function openfamilyPage() {
	            var url = Utils.setOpenUrl(this.$getConfig(), 'family-setting');
	            Utils.navigate.push(this, url, 'true');
	        },
	            ...
	            storage.getItem('jsessionid', function (e) {
	                ...
	                SJevent.PostSigalImg(paramJson, function (res) {
	                    if (res == 0) {
	                        ...
	                        var path = res.path;
	                        self.myPortraitUrl = Utils.ip + 'yjpt' + path;
	                        modal.alert({
	                            message: '图片---' + self.myPortraitUrl,
	                            okTitle: '好的'
	                        }, function () {});
	                    }
	                });
