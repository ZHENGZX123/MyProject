...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        var self = this;
	        self.phoneImg = Utils.ip + Utils.dir + '/' + 'yjpt/images/phone.png';
	        self.qrImg = Utils.ip + Utils.dir + '/' + 'yjpt/images/ewm.png';
	        self.pwdImg = Utils.ip + Utils.dir + '/' + 'yjpt/images/pwd.png';
