...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/89bcaf1a826b8afa5cd983ab225006b3', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/89bcaf1a826b8afa5cd983ab225006b3',undefined,undefined)
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "type": "text",
	                "placeholder": "请输入孩子生日",
	                "value": function () {return this.birthday}
	              },
	              "id": "work_title",
	              "events": {
	                "input": "dateFormat"
	...
	module.exports = {
		...
		created: function created() {
			...
			storage.getItem('birthday', function (e) {
				self.birthday = e.data != 'undefined' ? e.data : '';
			});
				...
				if (a.test(strDate)) {
					...
					if (!(dateElement.getFullYear() == parseInt(dateArray[0]) && dateElement.getMonth() + 1 == parseInt(dateArray[1]) && dateElement.getDate() == parseInt(dateArray[2]))) {
						...
						modal.alert({
							...
							storage.setItem('birthday', self.birthday, function (e) {});
					...
					modal.alert({
						message: '日期格式错误,请输入正确的格式(YYYY-MM-DD)',
						okTitle: '好的'
					}, function () {});
				}
			});
