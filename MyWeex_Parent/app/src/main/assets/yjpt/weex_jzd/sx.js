...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/8fe5bc80cf84e895862974476a6e0713', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/8fe5bc80cf84e895862974476a6e0713',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "rightItemSrc": function () {return this.headRImg}
	  },
	  "children": [
	    {
	      "type": "scroller",
	          ...
	          "children": [
	            {
	              ...
	              "repeat": function () {return this.msgList},
	              "events": {
	                "click": "openPage"
	              },
	              "children": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.msgFrom}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.msgDate}
	                      }
	                    }
	                  ]
	                },
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.msgTitle}
	                      }
	                    }
	                  ]
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        navBarHeight: 130,
	        dir: 'yjpt',
	        msgList: [{ msgTitle: '今天的数学作业为.', msgFrom: '李老师', msgDate: '一周前' }, { msgTitle: '小森林小朋友今天在学校的表现 非常的不错哦！.', msgFrom: '张老师', msgDate: '刚刚' }, { msgTitle: '今天的数学作业为.', msgFrom: '李老师', msgDate: '一周前' }, { msgTitle: '今天要带小朋友完成一项家庭任务.', msgFrom: '张老师', msgDate: '刚刚' }, { msgTitle: '今天的数学作业为.', msgFrom: '李老师', msgDate: '一周前' }, { msgTitle: '今天的数学作业为.', msgFrom: '张老师', msgDate: '刚刚' }, { msgTitle: '今天的数学作业为.', msgFrom: '李老师', msgDate: '一周前' }, { msgTitle: '今天的数学作业为.', msgFrom: '张老师', msgDate: '刚刚' }, { msgTitle: '今天的数学作业为.', msgFrom: '李老师', msgDate: '一周前' }, { msgTitle: '今天的数学作业为.', msgFrom: '张老师', msgDate: '刚刚' }, { msgTitle: '今天的数学作业为.', msgFrom: '李老师', msgDate: '一周前' }, { msgTitle: '今天的数学作业为.', msgFrom: '张老师', msgDate: '刚刚' }]
	    }},
	    created: function created() {
	        Utils.setOpenUrl(this.$getConfig(), this.msgList);
	        this.$on('naviBar.leftItem.click', function (e) {});
	        this.$on('naviBar.rightItem.click', function (e) {
	            var url = Utils.setOpenUrl(this.$getConfig(), 'sx_fsx');
