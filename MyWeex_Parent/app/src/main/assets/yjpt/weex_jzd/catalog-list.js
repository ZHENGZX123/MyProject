...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/a1ca6533552f4d0aedd2614299188493', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/a1ca6533552f4d0aedd2614299188493',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "style": {
	                ...
	                "fontSize": 38,
	                "textAlign": "center",
	                "color": function () {return this.txtColor}
	              },
	              "events": {
	                "click": function ($event) {this.getCourse(this.classId,this.$index,$event)}
	              },
	              "repeat": function () {return this.classNames},
	              "attr": {
	        ...
	        },
	        {
	          ...
	          "style": {
	            "marginTop": 94,
	            "height": function () {return this.isPaid==0?this.envHeight-230:this.envHeight-50},
	          ...
	          "children": [
	            {
	              "type": "cell",
	              "append": "tree",
	              "repeat": function () {return this.myCourse},
	              "events": {
	                "click": function ($event) {this.openUrl(this.section_id,this.froms,this.aim,$event)}
	              },
	              "shown": function () {return this.myCourse.length>0},
	              "children": [
	                {
	                  "type": "text",
	                  "classList": [
	                  ...
	                  "attr": {
	                    "value": function () {return this.create_day}
	                  }
	                },
	                {
	                  "type": "div",
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.aim}
	                      }
	                    },
	                    {
	                      "type": "div",
	                      ...
	                      "children": [
	                        {
	                          "type": "image",
	                          "attr": {
	                            "src": function () {return this.images.preview}
	                          },
	                          "classList": [
	                            "course_img"
	                          ]
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "src": function () {return this.images.rightArrow}
	                              }
	                            }
	                          ]
	                        }
	            ...
	            },
	            {
	              ...
	              "style": {
	                "backgroundColor": "#f4f1f1",
	                "display": function () {return this.doneLoading}
	              },
	              "events": {
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.loadingTxt}
	                  }
	                }
	              ]
	            }
	        ...
	        },
	        {
	          ...
	          "shown": function () {return this.isPaid==0},
	          "children": [
	            {
	              "type": "text",
	              "style": {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        images: {
	            ...
	            rightArrow: 'yjpt/images/play.png',
	            preview: 'yjpt/images/video_preview.jpg'
	        },
	        search: '',
	        loadingTxt: '正在加载中...',
	        doneLoading: 'none',
	        ...
	        orderStudent: [],
	        checkImgs: {
	            blankRadio: 'yjpt/images/un-checked.png',
	            selectRadio: 'yjpt/images/set-checkbox.png'
	        }
	    }},
	    created: function created() {
	        var self = this;
	        ...
	        Utils.changeImg(this.images, ['leftItemImg', 'rightArrow']);
	        Utils.changeImg(this.images, ['preview']);

	        Utils.changeImg(self.checkImgs, ['blankRadio', 'selectRadio']);
	        this.$on('naviBar.leftItem.click', function (e) {
	            Utils.navigate.pop(this, 'true');
	        });

	        self.envHeight = self.$getConfig().env.deviceHeight;
	        ...
	        storage.getItem('classNames', function (e) {
	            if (e.data != 'undefined') {
	                self.classNames = JSON.parse(e.data);
	                self.getCourse(self.classNames[0].classId, 0);
	            }
	        });
	    },
	    methods: {
	        redirect: function redirect(url, index) {
	            var self = this;

	            Utils.navigate.push(self, url, 'true');
	        },
	        openUrl: function openUrl(sectionId, froms, aim) {
	            var self = this;
	            self.sectionDetail.sectionId = sectionId;
	            self.sectionDetail.froms = froms;
	            self.sectionDetail.aim = aim;

	            storage.setItem('sectionDetail', (0, _stringify2.default)(self.sectionDetail), function () {});

	            var url = Utils.setOpenUrl(self.$getConfig(), 'subject-detail');
	            Utils.navigate.push(self, url, 'true');
	        },
	        opentakeUrl: function opentakeUrl() {
	            var self = this;
	            var url = Utils.setOpenUrl(self.$getConfig(), 'subscribe');
	            storage.setItem('classStudentInfo', (0, _stringify2.default)(self.classNames[self.currentIndex]), function () {});

	            storage.getItem('studentList', function (e) {
	                if (e.data != 'undefined') {
	                    self.studentList = JSON.parse(e.data);
	                    self.orderStudent = [];
	                    for (var i in self.studentList) {
	                        if (self.classNames[self.currentIndex].classId == self.studentList[i].classId) {
	                            var obj = {};

	                            obj.userId = self.studentList[i].userId;
	                            obj.className = self.classNames[self.currentIndex].name;
	                            obj.studentName = self.studentList[i].realname;
	                            obj.imgUrl = self.checkImgs.selectRadio;

	                            self.orderStudent.push(obj);
	                        }
	                    }

	                    storage.setItem('orderStudent', (0, _stringify2.default)(self.orderStudent), function () {});
	                    Utils.navigate.push(self, url, 'true');
	                }
	            });
	        },
	        getCourse: function getCourse(classId, index) {
	            var self = this;
	            for (var i in self.classNames) {
	                if (i == index) {
	                    self.classNames[index].txtColor = '#00cc99';
	                } else {
	                    self.classNames[i].txtColor = '#000';
	                }
	            }
	            self.currentIndex = index;
	            self.currentClassId = classId;
	            self.currentStudentId = self.classNames[index].id;

	            Utils.fetch({
	                url: '/app/class/' + classId + '/attend_course' + '?studentId=' + self.classNames[index].id + '&pageNo=' + self.pageNo,
	                method: 'get',
	                dataType: 'json',
	                success: function success(res) {
	                    if (res.data.StatusCode == '200') {
	                        self.isPaid = res.data.data.isPaid;
	                        self.myCourse = res.data.data.attendCourseList;

	                        if (self.myCourse.length <= 0) {
	                            self.loadingTxt = '暂无数据';
	                        } else {
	                            self.loadingTxt = '正在加载中...';
	                        }
	        ...
	        handleLoading: function handleLoading() {
	            ...
	            self.pageNo++;
	            self.doneLoading = 'flex';

	            Utils.fetch({
	                url: '/app/class/' + self.currentClassId + '/attend_course' + '?studentId=' + self.currentStudentId + '&pageNo=' + self.pageNo,
	                method: 'get',
	                dataType: 'json',
	                success: function success(res) {
	                    if (res.data.StatusCode == '200') {
	                        if (res.data.data.attendCourseList.length <= 0) {
	                            modal.toast({
	                                message: '已加载全部',
	                                duration: '0.5'
	                            });
	                            ...
	                            self.myCourse = self.myCourse.concat(res.data.data.attendCourseList);
	                        }
	        ...
	        resortData: function resortData(list) {
	            var self = this;
	            for (var i in list) {}
	        }
	    }
