...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/1281b8d2f784cc36418b1a1616086a89', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/1281b8d2f784cc36418b1a1616086a89',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "src": function () {return this.images.loading}
	              }
	            },
	            {
	              "type": "text",
	          ...
	          "children": [
	            {
	              "type": "image",
	              "attr": {
	                "src": function () {return this.logoPic}
	              },
	              "style": {
	                "width": 180,
	                "height": 180
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return this.product.name}
	              }
	            }
	          ]
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "src": function () {return this.arrRight},
	                "value": function () {return this.term.label}
	              },
	              "style": {
	                "fontSize": 34
	              }
	        ...
	        },
	        {
	          ...
	          "repeat": function () {return this.orderStudent},
	          "events": {
	            "click": function ($event) {this.radioCheck(this.$index,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
	              ...
	              "attr": {
	                "value": function () {return (this.className) + '的宝贝：' + (this.studentName)}
	              }
	            },
	            {
	              "type": "image",
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "src": function () {return this.arrRight},
	                "value": function () {return '￥' + (this.product.price?this.product.price:'0.00')}
	              },
	              "style": {
	                "color": "#ff6600",
	                "fontSize": 34
	        ...
	        {
	          "type": "div",
	          "shown": function () {return this.product.price!='0.00'},
	          "style": {
	            "margin": 30,
	            "width": 690,
	            "borderRadius": 8,
	...
	module.exports = {
	    data: (_data = {
	        ...
	        images: {
	            ...
	            loading: 'yjpt/images/loading.gif'
	        },
	        orderStudent: [],
	        logoPic: '',
	        classStudentInfo: {},
	        ...
	        studentList: [],
	        classMap: {}
	    }, (0, _defineProperty3.default)(_data, 'orderStudent', []), (0, _defineProperty3.default)(_data, 'totalPrice', 0), (0, _defineProperty3.default)(_data, 'remark', ''), (0, _defineProperty3.default)(_data, 'attach', {
	        payUserId: '',
	        childId: '',
	        classId: '',
	        schoolId: ''
	    }), (0, _defineProperty3.default)(_data, 'outTradeNo', ''), (0, _defineProperty3.default)(_data, 'orderList', []), (0, _defineProperty3.default)(_data, 'productPrice', 0), _data),
	    created: function created() {
	        var self = this;
	        self.headLeft = Utils.ip + Utils.dir + '/' + 'yjpt/images/id_right_bg.png';
	        self.arrRight = Utils.ip + Utils.dir + '/' + 'yjpt/images/arrows_right.png';
	        self.logoPic = Utils.ip + Utils.dir + '/' + 'yjpt/images/logo.png';

	        self.$on('naviBar.leftItem.click', function (e) {
	            Utils.navigate.pop(self, 'true');
	        });

	        Utils.changeImg(self.images, ['blankRadio', 'selectRadio', 'loading']);
	        for (var i in self.orderStudent) {
	            self.orderStudent[i].imgUrl = self.images.blankRadio;
	            self.orderStudent[0].imgUrl = self.images.selectRadio;
	        }
	        storage.getItem('userId', function (e) {
	            self.userId = e.data;
	            self.attach.payUserId = self.userId;
	        });

	        storage.getItem('classStudentInfo', function (e) {
	            if (e.data != 'undefined') {
	                self.classStudentInfo = JSON.parse(e.data);

	                self.attach.childId = self.classStudentInfo.userId;
	                self.attach.classId = self.classStudentInfo.classId;
	                self.attach.schoolId = self.classStudentInfo.schoolId;

	                storage.getItem('orderStudent', function (e) {
	                    if (e.data != 'undefined') {
	                        self.orderStudent = JSON.parse(e.data);
	                    }
	                });
	    ...
	    methods: {
	        radioCheck: function radioCheck(index) {
	            ...
	            if (self.orderStudent[index].imgUrl == self.images.blankRadio) {
	                self.orderStudent[index].imgUrl = self.images.selectRadio;
	            } else {
	                self.orderStudent[index].imgUrl = self.images.blankRadio;
	            }

	            self.orderList = [];
	            for (var i in self.orderStudent) {
	                if (self.orderStudent[i].imgUrl == self.images.selectRadio) {
	                    self.orderList.push(1);
	                }
	            }

	            self.product.price = self.orderList.length <= 0 ? '0.00' : self.productPrice;
	        },
	        getOrder: function getOrder() {
	            ...
	            self.isShow = 'flex';
	            Utils.fetch({
	                url: '/app/school/' + self.classStudentInfo.schoolId + '/product' + '?classId=' + self.classStudentInfo.classId,
	                method: 'get',
	                dataType: 'json',
	                success: function success(res) {
	                    if (res.data.StatusCode == '200') {
	                        self.product = res.data.data.product;
	                        self.term = res.data.data.term;
	                        self.totalPrice = res.data.data.product.price;
	                        self.remark = res.data.data.product.name;

	                        self.productPrice = res.data.data.product.price;

	                        self.refreshing = false;
	                        self.isShow = 'none';
	                        console.log(self.refreshing);
	        ...
	        createOrder: function createOrder() {
	            ...
	            Utils.fetch({
	                url: '/app/paymentOrder/createOrder',
	                data: 'produectId=' + self.product.id,
	                method: 'post',
	                dataType: 'json',
	                success: function success(res) {
	                    if (res.data.returnCode == '200') {
	                        self.outTradeNo = res.data.returnData.code;
	                    } else {
	                        modal.toast({
	        ...
	        getWXPay: function getWXPay() {
	            ...
	            var url = Utils.setOpenUrl(self.$getConfig(), 'catalog-list');

	            if (SJevent.WeChatPay) {
	                SJevent.WeChatPay({
	                    attach: self.attach,
