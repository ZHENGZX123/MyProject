...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/d5da754fdd8a4fc2dac82a7e95d07582', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/d5da754fdd8a4fc2dac82a7e95d07582',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        {
	          "type": "list",
	          "shown": function () {return this.classMembers.length>0},
	          "children": [
	            {
	              "type": "cell",
	              "append": "tree",
	              ...
	              "repeat": function () {return this.classMembers},
	              "id": "sb$index",
	              "children": [
	                {
	                  "type": "text",
	                  ...
	                  "shown": function () {return this.isBinding=='no'},
	                  "events": {
	                ...
	                },
	                {
	                  ...
	                  "shown": function () {return this.isBinding=='yes'},
	                  "events": {
	                    "click": function ($event) {this.redirect(this.$index,$event)}
	                  },
	                  "attr": {
	                    "value": function () {return (this.realname) + '（已绑定）'}
	                  }
	                },
	                {
	                  "type": "image",
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        redirect: function redirect(index) {
	            ...
	            storage.setItem('myBaby', (0, _stringify2.default)(self.classMembers[index]), function () {});

	            storage.setItem('bindRelation', 'yes', function () {});
