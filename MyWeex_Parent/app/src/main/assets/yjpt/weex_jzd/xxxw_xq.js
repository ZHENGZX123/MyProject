...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/e8dfda25de224e412b9d0878b47e1e48', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/e8dfda25de224e412b9d0878b47e1e48',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "title": function () {return this.infoTitle},
	    "titleColor": "white",
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    ...
	                    if (retdata.retcode == 1) {
	                        var obj = retdata.newsJ;
	                        var time = obj.create_date.replace(/\-/g, '/');
	                        ...
	                        var createtime = year + "/" + month + "/" + date1 + " " + hour + ":" + minutes;
	                        self.infoTitle = obj.title;
	                        self.schoolName = obj.schoolName;
	                        self.time = createtime;
	                        self.articleLead = obj.content;
	                    } else {}
	                }
	            });
	        });
