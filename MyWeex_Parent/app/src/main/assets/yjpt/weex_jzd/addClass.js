...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/69449b59d1be5e95651e14480cb9de26', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/69449b59d1be5e95651e14480cb9de26',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  created: function created() {
	    ...
	    this.leftImg = Utils.ip + 'yjpt/images/sys.png';
	  ...
	  methods: {
	    QRScan: function QRScan() {
	      ...
	      if (event.QRScan) {
	        event.QRScan('yes', function (res) {
	          var classId, className, teacherName;
	          storage.setItem('classId', res.classid, function (e) {});
	          storage.setItem('className', res.classname, function (e) {});
	          storage.setItem('teacherName', res.teacher, function (e) {});

	          var url = Utils.setOpenUrl(self.$getConfig(), 'xzwdbb');
