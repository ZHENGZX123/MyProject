...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/721e9923a91382ecad33f3bd8fa1e4da', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/721e9923a91382ecad33f3bd8fa1e4da',undefined,undefined)
	            ...
	            },
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "shown": function () {return this.picUrl},
	                  "children": [
	                    {
	                      "type": "image",
	                      "classList": [
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    ...
	    displayRefresh: 'show',
	    displayLoading: 'show',
	    photo: Utils.ip + 'yjpt/images/IMG_df.png',
	    itemList: []
	  }},
	  created: function created() {
	    ...
	    var self = this;
	    var childId, name, photo;
	    storage.getItem('name', function (e) {
	      self.name = e.data;
	    });
	    storage.getItem('photo', function (e) {
	      self.photo = e.data;
	    });
	    ...
	    storage.getItem('childId', function (e) {
	      childId = e.data;
	      Utils.fetch({
	        url: '/growth/getGrowthList',
	        data: 'pageNo=1&pageSize=100&childId=' + childId,
	        type: 'json',
	        method: 'POST',
	        success: function success(ret) {
	          ...
	          self.num = obj.startTime;
	          if (obj.retcode == 1) {
	            for (var i in obj.growthJList) {
	              var objse = obj.growthJList[i];
	              var img = [];
	              var time = objse.create_time.replace(/\-/g, '/');
	              ...
	              var createtime = month + "/" + date1 + " " + hour + ":" + minutes;

	              for (var j in objse.imagList) {
	                var imgObj = {
	                  picUrl: Utils.ip + 'yjpt' + objse.imagList[i]
	                };
	                img.push(imgObj);
	              }
	              var dataObj = {
	                content: objse.content,
	                img: img,
	                time: createtime
	              };
	              arr.push(dataObj);
	  ...
	  methods: {
	    ...
	    findVal: function findVal(index) {
	      var tempObj = {};
	      var tempAry = [];
	      for (var i = 0; i < index.length; i++) {
	        if (tempObj[index[i]]) {
	          tempAry.push(index[i]);
	        } else {
	          tempObj[index[i]] = true;
	        }
	      }
	      return tempAry;
	    },
