	      ...
	      "children": [
	        {
	          ...
	          "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.redirectqrUrl(this.qrUrl,this.classInfo.id,$event)}
	                  }
	                },
	                {
	                  "type": "div",
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return (this.classInfo.name) + '（' + (this.classInfo.gradeId) + '）'}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.schoolName}
	                      }
	                    }
	                  ]
	                },
	            ...
	            },
	            {
	              ...
	              "shown": function () {return !this.classInfo.mac},
	              "children": [
	                {
	                  "type": "text",
	                  "classList": [
	                ...
	                },
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.bindingBox(this.classInfo.id,$event)}
	                  },
	                  "attr": {
	                    "value": "绑定盒子"
	                  }
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return '宝盒编号：' + (this.classInfo.mac)}
	                  }
	                },
	                {
	                  "type": "text",
	                  ...
	                  "events": {
	                    "click": function ($event) {this.unBingdingBox(this.classInfo.id,$event)}
	                  },
	                  "attr": {
	                    "value": "解除绑定"
	                  }
	              ...
	              "children": [
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "events": {
	                        "click": function ($event) {this.redirectContact('class-contact-teachers',this.teachers,this.$index,$event)}
	                      },
	                      "children": [
	                        {
	                          "type": "div",
	                ...
	                },
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "events": {
	                        "click": function ($event) {this.redirectContact('class-contact-child',this.children,this.$index,$event)}
	                      },
	                      "children": [
	                        {
	                          "type": "div",
	...
	module.exports = {
	                            ...
	                            for (var i in self.teachers) {
	                                if (self.teachers[i]) {
	                                    if (!self.teachers[i].avatar) {
	                                        self.teachers[i].avatar = Utils.ip + Utils.dir + '/' + 'yjpt/images/photo_06.jpeg';
	                                    } else {
	    ...
	    methods: {
	        ...
	        redirectContact: function redirectContact(url, user, index) {
	            ...
	            storage.setItem('userProfile', (0, _stringify2.default)(user[index]), function () {});
	                                    ...
	                                    Utils.fetch({
	                                        ...
	                                        success: function success(ret) {
	                                            ...
	                                            if (data.StatusCode == '200') {
	                                                ...
	                                                storage.setItem('classList', (0, _stringify2.default)(self.classList), function () {});
	                                                self.showClass = 1;
	                                            } else {
	                                                modal.toast({
	                                                    message: '网络故障，请稍后再试！',
	        ...
	        bindingBox: function bindingBox(classId) {
	            var self = this;
	     ...
	     var modal = __weex_require__('@weex-module/modal');
	        ...
	        unBingdingBox: function unBingdingBox(classId) {
	            var self = this;
	            modal.confirm({
	                message: '确定要解除绑定吗？',
	                okTitle: '确定',
	                            ...
	                            if (res.data.StatusCode == '200') {
	                                ...
	                                Utils.fetch({
	                                    ...
	                                    success: function success(res) {
	                                        ...
	                                        storage.setItem('myClass', (0, _stringify2.default)(self.myClass), function () {});
	                                    }
	                                });
	                            } else {
	                                modal.toast({
