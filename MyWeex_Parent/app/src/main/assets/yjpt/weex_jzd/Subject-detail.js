...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/ae0ee4c32710b5529aff75e0de5aa1fd', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/ae0ee4c32710b5529aff75e0de5aa1fd',undefined,undefined)
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  "type": "video",
	                  "shown": function () {return this.srcUrl!=''},
	                  "classList": [
	                    "video"
	                  ],
	                  "events": {
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return this.listContent}
	              }
	            },
	            {
	              "type": "div",
	              ...
	              "children": [
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      "type": "text",
	                      "attr": {
	                        "value": function () {return '共' + (this.processList.length) + '节'}
	                      }
	                    }
	                  ]
	                },
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "repeat": function () {return this.processList},
	                      "events": {
	                        "click": function ($event) {this.switchVideo(this.$index,$event)}
	                      },
	                      "children": [
	                        {
	                          "type": "text",
	                          "shown": function () {return this.currentIndex==this.$index},
	                          "style": {
	                            "color": "#00cc99"
	                          },
	                          "attr": {
	                            "value": function () {return this.seq}
	                          }
	                        },
	                        {
	                          "type": "text",
	            ...
	            },
	            {
	              ...
	              "shown": function () {return this.courseTinyList.length>0},
	              "children": [
	                {
	                  "type": "text",
	                  "classList": [
	            ...
	            },
	            {
	              ...
	              "repeat": function () {return this.courseTinyList},
	              "shown": function () {return this.courseTinyList.length>0},
	              "events": {
	                "click": function ($event) {this.switchVideo(this.$index,$event)}
	              },
	                  ...
	                  "children": [
	                    {
	                      "type": "image",
	                      "attr": {
	                        "src": function () {return this.tinyCourseImg}
	                      },
	                      "classList": [
	                        "course_img"
	                      ]
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.resource.name}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.lessonState}
	                      }
	                    }
	                  ]
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        playStatus: '',
	        srcUrl: '',
	        listContent: "1.借助游戏能够认读“哭”“笑”“脸”三个汉字，理解并运用。                                                       2.知道镜子是生活用品，了解它的特点，激发幼儿的好奇心。                                                  3.能够识别哭、笑的表情，在游戏中体会不同表情的变化。",
	        myCourse: [{
	            id: 1,
	            name: '奇志玩趣课外篇一',
	        ...
	        processList: [],
	        currentIndex: 0,
	        tinyCourseImg: 'yjpt/images/yjptj_landisp.png'
	    }},
	    created: function created() {
	        var self = this;
	        self.targetPic = Utils.ip + Utils.dir + '/' + 'yjpt/images/target.png';
	        self.$on('naviBar.leftItem.click', function (e) {
	            Utils.navigate.pop(self, 'true');
	        });
	        self.leftItemImg = Utils.ip + Utils.dir + '/' + self.leftItemImg;
	        Utils.changeImg(self.videoList, ['videoPic']);
	        Utils.changeImg(self.myCourse, ['preview'], 'myCourse');

	        self.tinyCourseImg = Utils.ip + Utils.dir + '/' + self.tinyCourseImg;

	        storage.getItem('sectionDetail', function (e) {
	            if (e.data != 'undefined') {
	                self.sectionDetail = JSON.parse(e.data);
	                console.log(self.sectionDetail);

	                self.listContent = self.sectionDetail.aim;

	                Utils.fetch({
	                    url: '/app/course/section/' + self.sectionDetail.sectionId + '/parent' + '?froms=' + self.sectionDetail.froms,
	                    method: 'get',
	                    dataType: 'json',
	                    success: function success(res) {
	                        if (res.data.StatusCode == '200') {
	                            self.courseTinyList = res.data.data.courseTinyList;
	                            self.processList = res.data.data.processList;

	                            self.srcUrl = self.processList[0].resource.file_path + '?type=show';
	                        } else {
	                            modal.toast({
	    ...
	    methods: {
	        ...
	        onfail: function onfail() {
	            this.$call('modal', 'toast', { 'message': '视频地址失效', 'duration': '1' });
	        },

	        switchVideo: function switchVideo(index) {
	            var self = this;
	            self.currentIndex = index;
	            var el = self.$el('videowrap');
	            dom.scrollToElement(el, { offset: 0 });
	            self.srcUrl = self.processList[index].resource.file_path + '?type=show';
	        }
	    }
	};}
	/* generated by weex-loader */
