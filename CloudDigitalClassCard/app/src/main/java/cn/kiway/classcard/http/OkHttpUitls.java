package cn.kiway.classcard.http;
...
import cn.kiway.classcard.utils.Logger;
...
import static cn.kiway.classcard.http.CacheInterceptor.maxAge;
import static cn.kiway.classcard.utils.IContant.OKHTTPCACHE;
...
public class OkHttpUitls {
    ...
    public void uploadFile(String url, String path, final HttpCallBack callBack) {
        ...
        String fileMimeType = Utils.getMimeType(file);
