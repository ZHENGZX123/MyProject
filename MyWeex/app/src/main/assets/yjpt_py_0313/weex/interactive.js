...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/bdeaccf996d7afe5389032fbc8691fbf', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/bdeaccf996d7afe5389032fbc8691fbf',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "rightItemsSrc": "../yjpt/images/chevron.png"
	  },
	  "events": {
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.images.uploadImg}
	                  }
	                },
	                {
	                  "type": "image",
	                  ...
	                  "attr": {
	                    "src": function () {return this.images.cameraImg}
	                  }
	                }
	              ]
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        isShow: 0,
	        noticeId: 0,
	        url: 'showcase/new-fashion/personal',
	        itemList: [{
	            cake: 1,
	            name: '张老师',
	        ...
	        suberList: [{ title: '作业', noticeId: 2, pictureUrl: '../yjpt/images/icon_homework.png', url: 'showcase/new-fashion/interactive' }, { title: '通知', noticeId: 0, pictureUrl: '../yjpt/images/icon_notice.png', url: 'showcase/new-fashion/interactive' }],
	        images: {
	            leftItemImg: 'yjpt/images/id_right_bg.png',
	            rightItemImg: 'yjpt/images/group.png',
	            uploadImg: 'yjpt/images/picture.png',
	            cameraImg: 'yjpt/images/camera.png'
	        }
	    }},
	    created: function created() {
	        ...
	        this.$on('naviBar.rightItem.click', function (e) {
	            ...
	            Utils.navigate.push(this, this.url, 'true');
	        });
	        this.$on('naviBar.rightItems.click', function (e) {
	            this.isShow = this.isShow == 0 ? 1 : 0;
	        });
	        Utils.changeImg(this.images, ['leftItemImg', 'rightItemImg', 'uploadImg', 'cameraImg']);
