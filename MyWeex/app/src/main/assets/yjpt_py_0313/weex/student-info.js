	...
	module.exports = {
	  ...
	  "children": [
	    ...
	    },
	    {
	      ...
	      "shown": function () {return !this.isPublish},
	      "attr": {
	        "value": "发布"
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftItemImg', 'rightArrow', 'leftArrow']);
	        ...
	        storage.setItem('type', this.type, function () {});
	    },
	    methods: {
	        test: function test() {
	            storage.getItem('test', function (e) {
	                console.log(e.data);
	            });
	        },
