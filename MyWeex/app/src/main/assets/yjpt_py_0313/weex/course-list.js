...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/b53034ad04167b7d6f2d7732b27cbf75', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/b53034ad04167b7d6f2d7732b27cbf75',undefined,undefined)
	              ...
	              "children": [
	                {
	                  ...
	                  "shown": function () {return !this.isNoCourse},
	                  "children": [
	                    {
	                      "type": "div",
	                      "classList": [
	                    ...
	                    {
	                      "type": "div",
	                      "repeat": function () {return this.lessonList},
	                      "children": [
	                        {
	                          "type": "div",
	                          "shown": function () {return this.isFirst},
	                          "children": [
	                            {
	                              "type": "text",
	                              "style": {
	                              ...
	                              "attr": {
	                                "value": function () {return this.attend_date}
	                              }
	                            }
	                          ]
	                        },
	                        {
	                          ...
	                          "events": {
	                            "click": function ($event) {this.redirect(this.url,this.$index,$event)}
	                          },
	                          "children": [
	                            {
	                              "type": "div",
	                              ...
	                              "children": [
	                                {
	                                  "type": "image",
	                                  "attr": {
	                                    "src": function () {return this.preview}
	                                  },
	                                  "classList": [
	                                    "course_img"
	                                  ]
	                                },
	                                {
	                                  ...
	                                  "attr": {
	                                    "value": function () {return this.dir_type}
	                                  }
	                                }
	                              ]
	                            },
	                            {
	                              ...
	                              "children": [
	                                ...
	                                },
	                                {
	                                  ...
	                                  "attr": {
	                                    "value": function () {return (this.require_time) + '分钟'}
	                                  }
	                                },
	                                {
	                                  "type": "text",
	                                ...
	                                },
	                                {
	                                  ...
	                                  "attr": {
	                                    "src": function () {return this.images.videoBg}
	                                  },
	                                  "shown": function () {return this.hasVideo}
	                                }
	                              ]
	                        ...
	                        {
	                          "type": "div",
	                          "shown": function () {return this.index==this.latestIndex&&this.lessonList.length-1!=this.$index},
	                          "children": [
	                            {
	                              "type": "text",
	                              "style": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: (_data = {
	        ...
	        url: 'class-detail',
	        images: {
	            leftArrow: 'yjpt/images/arrow_left2.png',
	            rightArrow: 'yjpt/images/arrow_right2.png',
	            iconUrl: '../yjpt/images/arrow_down_red.png',
	            videoBg: '../yjpt/images/video_play.png'
	        },
	        course: {
	            id: 1,
	            attend_date: '2016-09-01',
	            hint: "提示信息",
	            suggest: "建议",
	            grade_id: '1'
	        },
	        ...
	        gradeId: '',
	        type: ''
	    }, (0, _defineProperty3.default)(_data, 'jsessionid', ''), (0, _defineProperty3.default)(_data, 'arr', []), (0, _defineProperty3.default)(_data, 'index', 0), _data),
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftArrow', 'rightArrow', 'iconUrl', 'videoBg']);

	        var self = this;
	        self.tabListCopy = JSON.parse((0, _stringify2.default)(self.tabList));
	        var startDate = parseInt(self.startDate.split('-')[2]);

	        for (var i = 0; i < self.tabListCopy.length; i++) {
	            self.tabListCopy[i].date = startDate + i;
	        }

	        var self = this;
	        var defaultDate = self.startDate;


	        setTimeout(function () {
	            storage.getItem('latestIndex', function (e) {
	                self.index = e.data;
	            });
	            storage.getItem('lessonList', function (e) {

	                if (e.data) {
	                    self.lessonList = JSON.parse(e.data);
	                    if (self.lessonList.length <= 0) {
	                        self.isNoCourse = true;
	                    } else {
	                        self.isNoCourse = false;
	                    }
	                }
	            });
	        }, 300);
	    ...
	    methods: {
	        ...
	        redirect: function redirect(url, index) {
	            var self = this;
	            storage.setItem('lessionId', self.lessonList[index].lessonId, function () {});
	            console.log('classId:' + self.classId);
	            if (event.ControllBox) {
	                event.ControllBox({
	                    lessonId: self.lessonList[index].lesson_id,
	        ...
	        selected: function selected(index) {
	            ...
	            for (var i = 0; i < this.tabListCopy.length; i++) {
	                var tabListCopy = this.tabListCopy[i];
	                if (i == index) {
	                    tabListCopy.titleColor = this.selectedColor;
	                    tabListCopy.backgroundColor = this.selectedbackgroundColor;
	                    tabListCopy.dateColor = this.selectedDateColor;
	                    tabListCopy.visibility = 'visible';
	                } else {
	                    tabListCopy.titleColor = this.unselectedColor;
	                    tabListCopy.backgroundColor = this.unselectedbackgroundColor;
	                    tabListCopy.dateColor = this.unselectedDateColor;
	                    tabListCopy.visibility = 'hidden';
	                }
	            }

	            var self = this;

	            var defaultDate = self.tabList[index].date;

	            var headers = { 'Content-Type': 'application/x-www-form-urlencoded' };
	            stream.fetch({
	                headers: headers,
	                method: "POST",
	                url: Utils.ip + 'yjpt' + '/course/get',
	                type: 'JSON',
	                body: 'classId=' + self.classId + '&gradeId=' + self.gradeId + '&date=' + defaultDate
	            }, function (response) {
	                if (!response.ok || response.ok == 0) {
	                    modal.toast({
	                        'message': '网络故障，请稍后再试！',
	                    ...
	                    var ret = response;
	                    if (data.retcode == '1') {
	                        if (data.lessonList.length > 0) {
	                            self.course = JSON.parse((0, _stringify2.default)(data.course));
	                            self.lessonList = JSON.parse((0, _stringify2.default)(data.lessonList));
	                            self.userdefLessonList = JSON.parse((0, _stringify2.default)(data.userdefLessonList));

	                            for (var i = 0; i < self.lessonList.length; i++) {
	                                self.setDirType(i);

	                                self.lessonList[i].preview = Utils.ip + self.dir + self.lessonList[i].preview + '?jsessionid=' + self.jsessionid;
	                            }
	                            self.isNoCourse = false;
	                        } else {
	                            self.isNoCourse = true;
	        ...
	        setDirType: function setDirType(i) {
	            var self = this;
	            if (self.lessonList[i].dir_type == '1') {
	                self.lessonList[i].dir_type = '主课';
	            } else if (self.lessonList[i].dir_type == '2') {
	                self.lessonList[i].dir_type = '微课';
	            } else {
	                self.lessonList[i].dir_type = '资源';
	            }
	        },
	        toggle: function toggle() {
	            this.isShow = !this.isShow;
	            this.txt = this.isShow == true ? '收起' : '展开';
	            this.iconUrl = this.isShow == true ? '../yjpt/images/arrow_up_red.png' : '../yjpt/images/arrow_down_red.png';
	        },
	        setPhoto: function setPhoto(i) {
	            var self = this;
	            self.lessonList[i].preview = Utils.ip + self.dir + self.lessonList[i].preview + '?jsessionid=' + self.jsessionid;
	        }
	    }
