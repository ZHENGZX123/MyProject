...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/3b14042dee4499ae2fc8df8b83fc13f4', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/3b14042dee4499ae2fc8df8b83fc13f4',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        var self;
	        var address = '广东省*深圳市*南山区';

	        for (var i in self.regionList) {
	            self.regionList[i].status = self.regionList[i].type == self.userSex ? self.images.selectRadio : self.images.blankRadio;
	        }
	    },
	    methods: {
	        radioCheck: function radioCheck(index) {
	            var self = this;
	            for (var i in self.regionList) {
	                self.regionList[i].isCheck = false;
	                self.regionList[index].isCheck = true;
	            }
	            storage.setItem('schoolName', this.regionList[index].name);
	            storage.setItem('schoolId', this.regionList[index].id);
	            setTimeout(function () {
