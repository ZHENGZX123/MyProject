...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/b26bf85429f61ab89e452549eaf20343', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/b26bf85429f61ab89e452549eaf20343',undefined,undefined)
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "type": "password",
	                "placeholder": "请输入旧密码",
	                "value": function () {return this.oldPwdTxt}
	              },
	              "events": {
	                "input": "oldPwdIn"
	              }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftItemImg']);

	        this.loginUrl = Utils.setOpenUrl(this.$getConfig(), this.loginUrl);
	    },
	    methods: {

	        oldPwdIn: function oldPwdIn(e) {
	            var self = this;
	            self.oldPwdTxt = e.value;
	        },
	        ...
	        updatePwd: function updatePwd() {
	            ...
	            Utils.fetch({
	                url: '/user/uppwLogin',
	                data: 'oldPassword=' + self.oldPwdTxt + '&newPassword=' + self.pwd2,
	                type: 'json',
	                method: 'POST',
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        modal.alert({
	                            ...
	                            Utils.navigate.push(self, self.loginUrl, 'true');
	                        });
