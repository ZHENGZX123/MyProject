...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/3ba12f803d6d024d68ef8ab9514d96a2', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/3ba12f803d6d024d68ef8ab9514d96a2',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "title": "一定要带孩子做9件事",
	    "titleColor": "white",
	    "leftItemSrc": function () {return this.images.leftImg}
	  },
	  "events": {
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.promulgator}
	                  }
	                },
	                {
	                  "type": "text",
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return '上一篇：' + (this.lastNet)}
	              }
	            },
	            {
	              "type": "text",
	              ...
	              "attr": {
	                "value": function () {return '下一篇：' + (this.lowerNet)}
	              }
	            }
	          ]
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        infoList: [{ infoTitle: '暑假到了，一定要带孩子做9件事', articleLead: '自2014年5月开始，“萤火虫露营”活动已经成功在天津“名洋湖庄园”举办了十多场，约一千多名儿童和家长在活动中感受到了萤火虫的神奇魅力… 2015年，“萤火虫露营”活动将进一步升级，不但继续保们最激动的时刻！跟随朝气蓬勃的蚂蚁哥哥和蚂蚁姐姐，围着熊熊燃烧的篝留丰富多彩的活动，而且还增加了一些更有趣，更好玩的环节，届时，萤火虫的光亮和孩子的笑脸将再一 次照耀夜空舒适安全的露营保障好的露营感受当然离不开优质的帐篷，萤火虫野营活动考虑到户外住宿的各种情况，为确保住宿的舒们最激动的时刻！跟随朝气蓬勃的蚂蚁哥哥和蚂蚁姐姐，围着熊熊燃烧的篝适性和安全，俱乐部甄选出最适合孩子和家长们睡眠的高品质、高性能帐篷产品，配以经过灭菌消毒的卫生寝具，为住宿家庭提供舒适、安全、透气的露营环境。萤火虫的童话世界萤火虫放飞：浩瀚的夜空，闪耀的萤火虫，童话世界装饰着孩子们的梦小朋友们将得到珍贵的萤火虫，默默的祈福，在夜色中放飞这些可爱的小精灵。备注：在四季如春的云南，我们为培育这些萤火虫小宝宝，特意给它们建造了一个温馨的家园，让它们安心的繁育，健康的成长。最后，乘飞机从千里之遥的家来到小朋友身边，带给小朋友惊喜与快乐！不眠的篝火狂欢之夜顶着漫天的繁星、唱着欢快的歌曲，在露营之夜，让孩子们最兴奋的不仅仅是美丽而又神秘的萤火虫，盛大的篝火晚会也将是孩子们最激动的时刻！跟随朝气蓬勃的蚂蚁哥哥和蚂蚁姐姐，围着熊熊燃烧的篝 火！今晚注定是一个不眠的狂欢之夜', promulgator: '海苔小丸子', infoType: '家长课堂', number: 1025, time: '1小时前', lastNet: '5月10日，手绘钱包活动回顾', lowerNet: '期末考，小学生如何做好考前准备' }],
	        images: {
	            leftImg: 'yjpt/images/id_right_bg.png'
	        }
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftImg']);
	    },
	    methods: {
