...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/aa1cb86a1992cbf6675e6c290f0a08b7', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/aa1cb86a1992cbf6675e6c290f0a08b7',undefined,undefined)
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.openPage(this.myMainUrl,$event)}
	              },
	              "children": [
	                {
	                  "type": "image",
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.openIofoPage(this.mailListUrl,$event)}
	              }
	            },
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    navBarHeight: 130,
	    dir: 'examples',
	    myInfo: [{ name: '原来', myPortraitUrl: '../yjpt/images/IMG_df.png' }],
	    images: {
	      leftItemImg: 'yjpt/images/id_right_bg.png'
	    },
	    myMainUrl: 'showcase/new-fashion/myMain',
	    mailListUrl: 'showcase/new-fashion/mail-list'
	  ...
	  created: function created() {
	    ...
	    this.myMainUrl = Utils.setOpenUrl(this.$getConfig(), this.myMainUrl);
	    this.mailListUrl = Utils.setOpenUrl(this.$getConfig(), this.mailListUrl);
	  },
	  methods: {
	    openPage: function openPage(url) {
	      Utils.navigate.push(this, url, 'true');
	    },
	    openIofoPage: function openIofoPage(url) {
	      Utils.navigate.push(this, url, 'true');
	    }
	  }
	};}
