...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/ba870aef8271aadd2cc5688f07682f9d', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/ba870aef8271aadd2cc5688f07682f9d',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "style": {
	            "display": function () {return this.visibility}
	          },
	          "repeat": function () {return this.tabListCopy},
	          "attr": {
	            "src": function () {return this.src},
	            "type": "weex"
	          }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        selectedColor: '#fff',
	        unselectedColor: '#666',
	        selectedbackgroundColor: '#0c9',
	        selectedDateColor: '#fff',
	        unselectedDateColor: '#666',
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['leftArrow', 'rightArrow']);
	        ...
	        Utils.fetch({
	            url: '/course/get',
	            data: 'classId=' + '169' + '&gradeId=' + '1' + '&date=' + defaultDate,
	            type: 'json',
	            method: 'POST',
	            success: function success(ret) {
	                if (ret.data.retcode == '1' && (0, _typeof3.default)(ret.data.course) == 'object') {
	                    self.course = JSON.parse((0, _stringify2.default)(ret.data.course));
	                    self.lessonList = JSON.parse((0, _stringify2.default)(ret.data.lessonList));
	                    self.userdefLessonList = JSON.parse((0, _stringify2.default)(ret.data.userdefLessonList));
	    ...
	    methods: {
	        ...
	        selected: function selected(index) {
	            for (var i = 0; i < this.tabListCopy.length; i++) {
	                ...
	                if (i == index) {
	                    ...
	                    tabListCopy.visibility = 'none';
	                }
	            }

	            var self = this;
	            self.$dispatch('tabItem.onClick', function () {
	                alert(123);
	            });
	            var defaultDate = self.startDate;
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        ...
	                        storage.setItem('course', (0, _stringify2.default)(self.course), function () {});
	                        storage.setItem('lessonList', (0, _stringify2.default)(self.lessonList), function () {});
	                        storage.setItem('userdefLessonList', (0, _stringify2.default)(self.userdefLessonList), function () {});
	                    } else {
	                        modal.toast({
	                            message: '网络故障，请稍后重试！',
	                            duration: '1'
	        ...
	        setDirType: function setDirType(i) {
	            var self = this;
	            if (self.lessonList[i].dirType == '1') {
	                self.lessonList[i].dirType = '主课';
	            } else if (self.lessonList[i].dirType == '2') {
	                self.lessonList[i].dirType = '微课';
	            } else {
	                self.lessonList[i].dirType = '资源';
	            }
	        }
	    }
