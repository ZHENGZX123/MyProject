...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/3d1fc85718615aa354fcd0e2d10e49c5', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/3d1fc85718615aa354fcd0e2d10e49c5',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/class-list-data', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	module.exports = {
	  ...
	  "children": [
	      ...
	      "children": [
	        {
	          ...
	          "shown": function () {return this.isJoinClass=='no'},
	          "events": {
	            "click": "chooseCity"
	          },
	          "children": [
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "value": function () {return this.classInfo.name}
	              }
	            },
	            {
	              "type": "div",
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.class.join(',')}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "type": "url",
	                "value": function () {return this.schoolCode},
	                "placeholder": "请输入邀请码"
	              },
	              "events": {
	                "input": "schoolCodeIn"
	        ...
	        },
	        {
	          ...
	          "shown": function () {return this.showClass==1},
	          "style": {
	            "zIndex": 999999
	          }
	        }
	    ...
	    },
	    {
	      ...
	      "shown": function () {return this.isShowSchools==1},
	      "children": [
	        {
	          "type": "div",
	          "classList": [
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        allChecked: '',
	        multiList: [{ name: '选项1', imgUrl: '' }, { name: '选项2', imgUrl: '' }, { name: '选项3', imgUrl: '' }],
	        classList: [],
	        url: 'class-main-page',
	        loginUrl: 'login',
	    ...
	    created: function created() {
	        ...
	        city.onmessage = function (e) {
	            self.countryId = e.data;
	        };
	    },
	    methods: {
	        ...
	        nextStep: function nextStep() {
	            ...
	            if (self.isJoinClass == 'no') {
	                subData = 'classList=' + classList.join("#") + '&inviteCode=' + self.schoolCode.toUpperCase();
	        ...
	        schoolCodeIn: function schoolCodeIn(e) {
	            var self = this;
