	      ...
	      "children": [
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.redirect(this.mineUrl,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.images.mineImg}
	                  }
	                },
	                {
	                  "type": "image",
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.gotoPage(this.myClass,this.$index,$event)}
	          },
	          "children": [
	            {
	              "type": "div",
	              ...
	              "children": [
	                {
	                  ...
	                  "style": {
	                    "borderRadius": function () {return this.stateOne}
	                  },
	                  "attr": {
	                    "src": function () {return this.images.classImg}
	                  }
	                },
	                {
	                  "type": "text",
	        ...
	        },
	        {
	          ...
	          "repeat": function () {return this.basicDataList3},
	          "events": {
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.titleName}
	                  }
	                },
	                {
	                  "type": "image",
	...
	module.exports = {
	    data: function () {return {
	        ...
	        images: {
	            ...
	            loadingImg: 'yjpt/images/loading.gif'
	        },
	        myClass: [],
	        basicDataList3: [{
	            titleName: '设置',
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['mineImg', 'loadingImg']);
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.data.StatusCode == '200') {
	                        ...
	                        if (user.avatar) {
	                            self.images.mineImg = user.avatar;
	                        }
	                    }
	                }
	            });

	            var userImg = new BroadcastChannel('userImg');
	            userImg.onmessage = function (e) {
	                self.images.mineImg = e.data;;
	            };
	        });
	    },
	    methods: {
	        gotoPage: function gotoPage(myClass, index) {
	            var self = this;
	            storage.setItem('classInfo', (0, _stringify2.default)(myClass[index]), function () {});
