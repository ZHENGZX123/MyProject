...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/6c11c6b3154e41e47bd1cd582dd585cd', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/6c11c6b3154e41e47bd1cd582dd585cd',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "title": function () {return this.libraryName},
	    "titleColor": "white",
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return '共' + (this.lessonList.length) + '个课时'}
	                  }
	                }
	              ]
	            },
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.redirect(this.url,this.$index,this.aim,this.teaching_prepare,$event)}
	              },
	              "children": [
	                {
	                  "type": "div",
	                ...
	                },
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return '建议时长：' + (this.require_time) + '分钟'}
	                      }
	                    },
	                    {
	                      "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        navBarHeight: 130,
	        dir: 'yjpt',
	        courseList: [{ courseTitle: '抢松鼠的松果', courseImg: '../yjpt/images/64871195851344.jpg', courseTime: 20, courseBtn: '查看教案', url: 'major-class-detail' }, { courseTitle: '抢松鼠的松果2', courseImg: '../yjpt/images/11002812962201869.jpg', courseTime: 30, courseBtn: '查看目标', url: 'major-class-detail' }],
	        images: {
	    ...
	    methods: {
	        redirect: function redirect(url, index, aim, prepare) {
	            var self = this;
