...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/7ddb7c8dba77d5eadbd42fa71402afe6', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/7ddb7c8dba77d5eadbd42fa71402afe6',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "value": function () {return '表现' + (this.tableHead[2].headTitle)}
	          }
	        }
	      ]
	    },
	      ...
	      "children": [
	        {
	          ...
	          "repeat": function () {return this.studentData},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.changeStatus(this.$index,$event)}
	          },
	          "style": {
	            "fontSize": 40,
	            "textAlign": "center"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        studentData: [{
	            id: '20160101', childName: '张晓明_s', radioStatus: [{ status: '' }, { status: '' }, { status: '' }] }, {
	            id: '20160102', childName: '张晓明_s', radioStatus: [{ status: '' }, { status: '' }, { status: '' }] }, {
	            id: '20160103', childName: '张晓明_s', radioStatus: [{ status: '' }, { status: '' }, { status: '' }] }],
	    ...
	    created: function created() {
	        ...
	        for (var i in this.studentData) {
	            for (var j in this.studentData[i].radioStatus) {
	                this.studentData[i].radioStatus[j].status = this.images.blankRadio;
	                this.studentData[i].radioStatus[j].status = j == 1 ? this.images.selectRadio : this.images.blankRadio;
	            }
	        }
	    },
	    methods: {
	        radioCheck: function radioCheck(index, id) {
	            ...
	            for (var i in this.studentData) {
	                if (this.studentData[i].id == id) {
	                    if (this.studentData[i].radioStatus[index].status == this.images.blankRadio) {
	                        for (var l in this.studentData[i].radioStatus) {
	                            this.studentData[i].radioStatus[l].status = this.images.blankRadio;
	                        }
	                        this.studentData[i].radioStatus[index].status = this.images.selectRadio;
	                    }
	                }
	            }
	        },
	        ...
	        addStatus: function addStatus(i) {},
	        changeStatus: function changeStatus(index) {
	            var self = this;
	            self.childrenList[index].status = !self.childrenList[index].status;
	        }
	    }
	};}
	/* generated by weex-loader */
