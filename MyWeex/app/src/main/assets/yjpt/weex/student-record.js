...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/f9c2b9a79d15afb9d6125ab4ad175361', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/f9c2b9a79d15afb9d6125ab4ad175361',undefined,undefined)
	...
	module.exports = {
	    data: function () {return {
	        ...
	        itemList: [{
	            ...
	            date: '3小时前',
	            praiseFlag: 1,
	            hit: ['原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来', '原来'],
	            praise: [{
	                id: 1,
	                name: '小张',
	                content: '测试测试今日8点33分著名表演艺术家葛存壮因脑梗引发心脏衰竭去世。',
	                date: '3小时前'
	            }, {
	                id: 2,
	                name: '小李',
	        ...
	        growthJList: [{
	            id: 91, owner: 54890, create_time: '2016-08-31 14:57:20', content: '我没什么第六季上课算有',
	            imagList: [{ id: 310, growth_id: 91, image_path: '/photo/0A26E4F85BA6F3F994739502A7867753.jpg' }, { id: 310, growth_id: 91, image_path: '/photo/0A26E4F85BA6F3F994739502A7867753.jpg' }, { id: 310, growth_id: 91, image_path: '/photo/0A26E4F85BA6F3F994739502A7867753.jpg' }, { id: 311, growth_id: 91, image_path: '/photo/0A26E4F85BA6F3F994739502A7867753.jpg' }],
	            ispublic: 1,
	            child_id: 132,
	            child_name: '宝宝',
	            avatar: '/avatar/300C184301577E9D0F741C4FA8BD3161.png'
	        }],
	        growthJListCopy: [],
	        pageNo: 1,
	        pageSize: 10,
	    ...
	    created: function created() {
	        for (var i = 0; i < this.itemList.length; i++) {
	            this.itemList[i].hit = this.itemList[i].hit.join();
	        }
	        ...
	        Utils.changeImg(this.growthJList, ['avatar', 'image_path'], 'imagList');
	        this.leftItemImg = Utils.changeImg(this.leftItemImg);
	        this.defaultPhoto = Utils.changeImg(this.defaultPhoto);
	        ...
	        storage.getItem('classId', function (e) {
	            ...
	            self.loading = true;
	            Utils.fetch({
	                url: '/growth/getCGrowthList',
	                data: 'classId=' + self.classId + '&pageNo=' + self.pageNo + '&pageSize=' + self.pageSize,
	                type: 'json',
	                method: 'POST',
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        ...
	                        for (var i = 0; i < self.growthJListCopy.length; i++) {
	                            ...
	                            self.growthJListCopy[i].avatar = self.growthJListCopy[i].avatar == null ? self.defaultPhoto : Utils.ip + self.dir + self.growthJListCopy[i].avatar + '?jsessionid=' + self.jsessionid;

	                            self.growthJListCopy[i].create_time = Utils.time(self.growthJListCopy[i].create_time);
	    ...
	    methods: {
	        ...
	        getFormerData: function getFormerData() {
	            ...
	            if (self.isLoadAllData == true) {
	                ...
	                Utils.fetch({
	                    ...
	                    success: function success(ret) {
	                        if (ret.data.retcode == 1) {
	                            if (ret.data.growthJList.length <= 0) {
	        ...
	        redirect: function redirect(url, index) {
	            ...
	            storage.setItem('childId', self.growthJListCopy[index].child_id, function () {});
	            storage.setItem('childName', self.growthJListCopy[index].child_name, function () {});
	            storage.setItem('childPhoto', self.growthJListCopy[index].avatar, function () {});
	        },
	        goBottom: function goBottom() {
	            var self = this;
	            var bottom = self.$el('bottom');
	            dom.scrollToElement(bottom);
	        }
	    }
	};}
	/* generated by weex-loader */
