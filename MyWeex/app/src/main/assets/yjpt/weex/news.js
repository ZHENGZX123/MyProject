...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/da71bac116d78eb18522addeee0744d2', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/da71bac116d78eb18522addeee0744d2',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: (0, _defineProperty3.default)({
	        ...
	        url: 'info-detail',
	        classId: ''
	    }, 'url', 'yjpt/tjsp/news/js_list.jsp'),
	    created: function created() {
	        ...
	        storage.getItem('userId', function (e) {
	            self.url = Utils.ip + self.url + '?userId=' + e.data + '&classId=' + self.classId + '&isParent=2';
	        });
	    },
	    methods: {
