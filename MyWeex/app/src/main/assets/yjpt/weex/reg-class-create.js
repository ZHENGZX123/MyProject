...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/038be0d07cbd5c29a6b356e906f47050', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/038be0d07cbd5c29a6b356e906f47050',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.redirect(this.regionList,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.redirect(this.schoolsList,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        selectedValue: '小班',
	        isShow: false,
	        selectOptions: [{ classType: '小班' }, { classType: '中班' }, { classType: '大班' }]
	    }},
	    created: function created() {

	        Utils.changeImg(this.images, ['leftItemImg', 'qrImg', 'arrowRight']);
	    ...
	    methods: {
	        ...
	        nextStop: function nextStop() {
	            ...
	            Utils.fetch({
	                ...
	                data: 'userId=' + this.schoolData.userId + '&schoolId=' + this.schoolData.schoolId + '&className=' + this.schoolData.className + '&gradeId=' + this.schoolData.gradeId,
	                type: 'json',
	                method: 'POST',
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        storage.setItem('className', self.schoolData.className);
	                        storage.setItem('gradeId', self.schoolData.gradeId);
	                        storage.setItem('schoolId', self.schoolData.schoolId);
