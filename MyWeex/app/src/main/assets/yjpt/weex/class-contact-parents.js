...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/2740debbe75fc583e4d828c361a42c70', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/2740debbe75fc583e4d828c361a42c70',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "src": function () {return this.userData.photo}
	              }
	            },
	            {
	              "type": "text",
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.callPhone(this.userData.phone,$event)}
	          },
	          "attr": {
	            "value": "呼叫"
	          }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        var self = this;
	        storage.getItem('parentName', function (e) {
	            if (e.data != 'undefined') {
	                self.userData.name = e.data;
	            }
	        });

	        storage.getItem('parentPhone', function (e) {
	            if (e.data != 'undefined') {
	                self.userData.phone = e.data;
	            }
	        });

	        storage.getItem('parentPhoto', function (e) {
	            if (e.data != 'undefined') {
	                self.userData.photo = e.data;
	            }
	        });
