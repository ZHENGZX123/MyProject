...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/db545f67679f735f8f4f34e334f7b737', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/db545f67679f735f8f4f34e334f7b737',undefined,undefined)
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "children": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "src": function () {return this.images.phoneImg}
	                      }
	                    }
	                  ]
	                },
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "src": function () {return this.images.pwdImg}
	                      }
	                    }
	                  ]
	                },
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "type": "password",
	                    "value": function () {return this.pwd2},
	                    "placeholder": "请确认密码"
	                  },
	                  "events": {
	                    "input": "pwdDouble"
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.verCodeText}
	                  }
	                }
	              ]
	            }
	    ...
	    {
	      "type": "loading",
	      "shown": function () {return !this.doneLoad}
	    }
	  ]
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        navBarHeight: 130,
	        dir: 'yjpt',
	        requestUrl: 'http://127.0.0.1:12680/yjpts',
	        images: {
	            phoneImg: 'yjpt/images/login_phone1.png',
	            qrImg: 'yjpt/images/login_ewm.png',
	            pwdImg: 'yjpt/images/pwd.png'
	        },
	        url: 'login',
	        nameUrl: 'name-setting',
	        phoneNumber: '',
	        pwd2: '',
	        pwd: '',
	        verCode: '',
	    ...
	    created: function created() {
	        Utils.changeImg(this.images, ['phoneImg', 'qrImg', 'pwdImg']);
	        ...
	        this.nameUrl = base + this.nameUrl + '.js';
	    },
	    methods: {
	        redirect: function redirect(url) {
	            Utils.navigate.push(this, url, 'true');;
	        },
	        numberTypeIn: function numberTypeIn(e) {
	            this.phoneNumber = e.value;
	            if (/^1[3|4|5|7|8]\d{9}$/.test(this.phoneNumber) && this.phoneNumber != "") {
	        ...
	        pwdDouble: function pwdDouble(e) {
	            this.pwd2 = e.value;
	            if (/\S{6,}/.test(this.pwd2) && this.pwd2 == this.pwd) {
	                this.pwdDoubleCheck = true;
	            } else {
	        ...
	        verCodeIn: function verCodeIn(e) {
	        ...
	        getVerCode: function getVerCode() {
	            var self = this;
	            self.phoneNumber = self.$el("phoneNumber").attr.value;
	            var phone = self.phoneNumber;
	            if (!/^1[3|4|5|7|8]\d{9}$/.test(self.phoneNumber) || self.phoneNumber == "") {
	                modal.toast({
	                    message: '请输入正确的手机号码',
	                    okTitle: '好的'
	                });
	        ...
	        regHandle: function regHandle() {
	            storage.setItem('isNewUser', this.isNewUser, function () {});
	            ...
	            Utils.fetch({
	                url: '/registApp',
	                data: 'phone=' + this.phoneNumber + '&password=' + this.pwd2 + '&vm=' + this.verCode + '&type=1',
	                method: "POST",
	                type: "json",
	                success: function success(ret) {
	                    if (ret.data.retcode == "1") {
	                        storage.setItem('userId', ret.data.userId, function () {});
	                        self.doneLoad = true;
	                        storage.setItem('isNewUser', self.isNewuser, function () {});
	                        modal.alert({
	                            message: '注册成功，请完善信息',
	                            okTitle: '好的'
	                        }, function () {
	                            setTimeout(function () {
	                                Utils.navigate.push(self, self.nameUrl, 'true');
	                            }, 600);
	                        });
	                    }
	                    if (ret.data.retcode == "11") {
	                        modal.toast({
	                            message: '验证码错误',
	                    ...
	                    if (ret.data.retcode == "22") {
	                        ...
	                        modal.confirm({
	                            ...
	                            if (ret == '好的') {
	                                storage.setItem('phone', self.phoneNumber, function () {});
