...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/fc85582787c8477ae8c8e70e97d61a45', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/fc85582787c8477ae8c8e70e97d61a45',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.updatePwdPage(this.updatePwdUrl,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
	...
	module.exports = {
	    data: function () {return {
	        ...
	        versionData: (_versionData = {
	            ...
	            iosyjptj: "",
	            iosyjpty: ""
	        }, (0, _defineProperty3.default)(_versionData, 'result', ""), (0, _defineProperty3.default)(_versionData, 'yjhz', ""), (0, _defineProperty3.default)(_versionData, 'yjptj', ""), (0, _defineProperty3.default)(_versionData, 'yjpty', ""), _versionData),
	        userId: '',
	        updatePwdUrl: 'update-pwd'
	    }},
	    created: function created() {
	        ...
	        this.updatePwdUrl = base + this.updatePwdUrl + '.js';
	        ...
	        storage.getItem('userId', function (e) {
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.status == '200') {
	                        self.versionData = JSON.parse((0, _stringify2.default)(ret.data));
	                    } else {
	                        modal.toast({
	                            message: '网络故障，请稍后重试！',
	                            duration: '1'
	    ...
	    methods: {
	        openserviceAPage: function openserviceAPage() {
	            this.$openURL(Utils.setOpenUrl(this.$getConfig(), 'fwxy'));
	        },
	        updatePwdPage: function updatePwdPage(url) {
	            Utils.navigate.push(this, url, 'true');;
	        },
	        checkVersion: function checkVersion() {
	            var self = this;
	            var currentVersion = parseInt(self.versionData.iosyjpty);
	            Utils.fetch({
	                url: '/version/getVersion',
	                data: 'id=' + self.userId,
	                type: 'json',
	                ...
	                success: function success(ret) {
	                    if (ret.status == '200') {
	                        var lastestVersion = parseInt(ret.data.iosyjpty);
	                        if (lastestVersion > currentVersion) {} else {
	                            modal.toast({
	                                message: '已经是最新版本了',
	                                duration: '1'
	                            });
