...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/08658b879f119d0d1b280739a3aa8cf3', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/08658b879f119d0d1b280739a3aa8cf3',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.countryId}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "value": function () {return this.schoolData.schoolType}
	              }
	            },
	            {
	              "type": "div",
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.schoolData.schoolName}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "value": function () {return this.selectedValue}
	              }
	            },
	            {
	              "type": "image",
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "repeat": function () {return this.selectOptions},
	                      "id": function () {return 'options_' + (this.$index)},
	                      "events": {
	                        "click": function ($event) {this.optionsSelect(this.$index,$event)}
	                      },
	                      "attr": {
	                        "value": function () {return this.classType}
	                      }
	                    }
	                  ]
	                }
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "placeholder": "如小星星，最多20个字",
	                "value": function () {return this.schoolData.className}
	              },
	              "events": {
	                "input": "classNameIn"
	              }
	        ...
	        {
	          "type": "text",
	          "classList": function () {return [this.isGray==false?'next_step':'btnGray']},
	          "events": {
	            "click": "nextStop"
	          },
	          "attr": {
	    ...
	    },
	    {
	      ...
	      "shown": function () {return this.isShowSchools},
	      "children": [
	        {
	          "type": "div",
	          "classList": [
	          ...
	          "repeat": function () {return this.schoolList},
	          "events": {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "shown": function () {return this.isCheck},
	              "attr": {
	                "src": function () {return this.images.selectRadio}
	              }
	            },
	            {
	              "type": "image",
	              ...
	              "shown": function () {return !this.isCheck},
	              "attr": {
	                "src": function () {return this.images.blankRadio}
	              }
	            }
	          ]
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        selectedValue: '小班',
	        isShow: false,
	        selectOptions: [{ classType: '小班' }, { classType: '中班' }, { classType: '大班' }, { classType: '大大班' }],
	        countryId: '请选择地区',
	        doneLoad: false,
	        address: '',
	        isShowCity: false,
	    ...
	    created: function created() {
	        ...
	        storage.getItem('schoolId', function (e) {
	            console.log('schoolId-storage:' + e.data);
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        ...
	                        console.log('countyId:' + self.countryId);
	    ...
	    methods: {
	        ...
	        classNameIn: function classNameIn(e) {
	            this.schoolData.className = e.value.replace(/\s/g, "");
	            if (this.schoolData.className != '') {
	                this.isGray = false;
	            }
	        },
	        ...
	        optionsSelect: function optionsSelect(index) {
	        ...
	        nextStop: function nextStop() {
	            var self = this;
	            if (self.isGray == true) {
	                return;
	            }
	            if (this.schoolData.schoolName == '' || this.schoolData.schoolName == '请选择学校') {
	                modal.alert({
	                    message: '请选择学校',
	                    okTitle: '好的'
	                });
	            ...
	            Utils.fetch({
	                url: '/yjpclass/createClass',
	                data: 'userId=' + self.schoolData.userId + '&schoolId=' + self.schoolData.schoolId + '&className=' + self.schoolData.className + '&gradeId=' + self.schoolData.gradeId,
	                type: 'json',
	                method: 'POST',
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        ...
	                        modal.alert({
	                            message: '班级创建成功，现在请为班级添加宝贝吧',
	                            okTitle: '好的'
	                        }, function () {
	                            if ('请选择'.indexOf(self.schoolAddress) <= 0) {
	                                self.address = self.location;
	                            }
	                            Utils.fetch({
	                                url: '/userInfo/updateUserInfo',
	                                data: 'userId=' + self.schoolData.userId + '&countyId=' + self.address,
	                                type: 'json',
	                                method: 'POST',
	                                success: function success(ret) {
	                                    Utils.navigate.push(self, Utils.setOpenUrl(self.$getConfig(), 'class-main-page'), 'true');
	                                }
	                            });
	                        });
	                    } else if (ret.data.retcode == '11') {} else if (ret.data.retcode == '22') {
	                        modal.alert({
	                            message: '班级名称已被占用，换一个吧',
	                            okTitle: '好的'
	                        });
	                ...
	                Utils.fetch({
	                    ...
	                    success: function success(ret) {
	                        ...
	                        if (data.setcode == '1') {
	                            ...
	                            self.schoolList = JSON.parse((0, _stringify2.default)(data.schools));
	                        } else {
	                            modal.toast({
	                                message: '网络故障，请稍后再试！',
	                                duration: '1'
	        ...
	        radioCheck: function radioCheck(index) {
	            ...
	            console.log(self.schoolData.schoolId);
	            self.isShowSchools = false;
	        }
	    }
	};}
