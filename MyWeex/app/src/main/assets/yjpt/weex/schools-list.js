...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/dbb5979e83148a6f4facf5bdca718a61', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/dbb5979e83148a6f4facf5bdca718a61',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        {
	          "type": "div",
	          "shown": function () {return this.schoolList.length<=0},
	          "children": [
	            {
	              "type": "text",
	              "style": {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        storage.getItem('userName', function (e) {
	            ...
	            self.countRemain = self.countRemain - self.userName.length;
	        });
	        ...
	        var self = this;
	        Utils.changeImg(this.images, ['leftItemImg', 'selectRadio', 'blankRadio']);

	        var self;
	        storage.getItem('schoolAddress', function (e) {
	            console.log('schoolAddress:' + e.data);
	            if (e.data != 'undefined') {
	                self.address = e.data;
	                Utils.fetch({
	        ...
	        for (var i in self.schoolList) {
	            self.schoolList[i].status = self.schoolList[i].type == self.userSex ? self.images.selectRadio : self.images.blankRadio;
	        }
	    },
	    methods: {
	        radioCheck: function radioCheck(index) {
	            ...
	            setTimeout(function () {
	                Utils.navigate.push(self, Utils.setOpenUrl(self.$getConfig(), 'class-create'), 'true');
	            }, 200);
	        }
	    }
	};}
