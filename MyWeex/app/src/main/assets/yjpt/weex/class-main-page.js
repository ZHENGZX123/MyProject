...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/2ba08af88b3d904899a389f466654d06', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/2ba08af88b3d904899a389f466654d06',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.images.qrImg}
	                  },
	                  "events": {
	                    "click": function ($event) {this.redirect(this.qrUrl,$event)}
	                  }
	                },
	                {
	                  "type": "div",
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return (this.classInfo.className) + '（' + (this.classInfo.grade) + '）'}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.classInfo.schoolName}
	                      }
	                    }
	                  ]
	                },
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.redirect(this.printUrl,$event)}
	                  },
	                  "children": [
	                    {
	                      "type": "image",
	                      ...
	                      "attr": {
	                        "src": function () {return this.images.printIcon}
	                      }
	                    },
	                    {
	                      "type": "text",
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.teachers.length}
	                      }
	                    },
	                    {
	                      "type": "text",
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.children.length}
	                      }
	                    },
	                    {
	                      "type": "text",
	            ...
	            },
	            {
	              ...
	              "shown": function () {return !this.binding},
	              "children": [
	                {
	                  "type": "text",
	                  "classList": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return '宝盒编号：' + (this.hCode)}
	                  }
	                },
	                {
	                  "type": "text",
	              ...
	              "children": [
	                {
	                  ...
	                  "shown": function () {return this.teachers.length>0},
	                  "children": [
	                    {
	                      "type": "text",
	                      "classList": [
	                    ...
	                    },
	                    {
	                      ...
	                      "repeat": function () {return this.teachers},
	                      "events": {
	                        "click": function ($event) {this.redirectContact(this.contactUrl,this.teachers,this.$index,$event)}
	                      },
	                      "children": [
	                        {
	                          "type": "image",
	                ...
	                },
	                {
	                  ...
	                  "shown": function () {return this.children.length>0},
	                  "children": [
	                    {
	                      "type": "text",
	                      "classList": [
	                    ...
	                    },
	                    {
	                      ...
	                      "repeat": function () {return this.children},
	                      "events": {
	                        "click": function ($event) {this.redirectContact(this.contactUrlChild,this.children,this.$index,$event)}
	                      },
	                      "children": [
	                        {
	                          "type": "image",
	                        ...
	                        },
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.child_name}
	                          }
	                        },
	                        {
	                          "type": "image",
	              ...
	              "children": [
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "shown": function () {return this.ownerId==this.userId},
	                      "events": {
	                        "click": "quitClass"
	                      },
	                      "attr": {
	                    ...
	                    },
	                    {
	                      ...
	                      "shown": function () {return this.ownerId==this.userId},
	                      "events": {
	                        "click": function ($event) {this.redirectMenu(this.modifyUrl,$event)}
	                      },
	                      "style": {
	                        "borderBottomWidth": 0
	                      },
	...
	module.exports = {
	    ...
	    created: function created() {
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        self.loading = false;
	                        self.teachers = JSON.parse((0, _stringify2.default)(ret.data.teacherList));
	                        self.children = JSON.parse((0, _stringify2.default)(ret.data.childrenList));
	                        console.log(self.teachers);
	                        for (var i = 0; i < self.teachers.length; i++) {
	                            self.setPhotoUrlTea(i, self.teachers[i].photo);
	                        }

	                        for (var j = 0; j < self.children.length; j++) {
	                            self.setPhotoUrlChil(j, self.children[j].avatar);
	                        }
	                    } else {
	                        modal.toast({
	                            message: '网络故障，请稍后再试！',
	        ...
	        storage.getItem('className', function (e) {
	            self.classInfo.className = e.data;
	        });

	        storage.getItem('gradeId', function (e) {
	            if (e.data != 'undefined') {
	                self.classInfo.grade = e.data;
	                if (self.classInfo.grade == '4') {
	                    self.classInfo.grade = '小班';
	                } else if (self.classInfo.grade == '3') {
	                    self.classInfo.grade = '中班';
	                } else if (self.classInfo.grade == '2') {
	                    self.classInfo.grade = '大班';
	                } else {
	                    self.classInfo.grade = '大大班';
	                }
	            }
	        });

	        storage.getItem('ownerId', function (e) {
	            self.ownerId = e.data;
	            console.log('ownerId:' + e.data);
	        });
	        ...
	        storage.getItem("school", function (e) {
	            if (e.data != 'undefined') {
	                self.classInfo.schoolName = e.data;
	            }
	        });
	        ...
	        storage.getItem("userId", function (e) {
	            ...
	            Utils.fetch({
	                ...
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        for (var i = 0; i < ret.data.classList.length; i++) {
	                            if (ret.data.classList[i].id == self.classId) {
	                                if (ret.data.classList[i].hCode != 'null' && ret.data.classList[i].hCode != null) {
	                                    self.binding = true;
	                                    self.hCode = ret.data.classList[i].hCode;
	                                } else {
	                                    self.binding = false;
	                                }
	                            }
	                        }
	                        storage.setItem('joinedClass', (0, _stringify2.default)(ret.data.classList), function () {});
	                    }
	                }
	            });
	        });

	        Utils.changeImg(this.teachers, ['photo']);
	    ...
	    methods: {
	        redirectContact: function redirectContact(url, type, index) {
	            storage.setItem('contactName', type[index].name, function () {});
	            storage.setItem('contactPhone', type[index].phone, function () {});
	            storage.setItem('contactId', type[index].id, function () {});

	            if (type[index].photo) {
	                storage.setItem('photo', type[index].photo, function () {});
	            } else if (type[index].avatar) {
	                storage.setItem('avatar', type[index].avatar, function () {});
	            }
	        ...
	        redirectMenu: function redirectMenu(url) {
	            Utils.navigate.push(this, url, 'true');;
	                ...
	                if (res == '确定') {
	                    storage.getItem('userId', function (e) {
	                        Utils.fetch({
	                            ...
	                            data: 'classId=' + self.classId + '&teacherId=' + self.userId,
	                            type: 'json',
	                            method: 'POST',
	                            success: function success(ret) {
	                                if (ret.data.retcode == '1') {
	        ...
	        bindingBox: function bindingBox() {
	            var self = this;
	            if (event.QRScan) {
	                storage.getItem('classId', function (e) {
	                    event.QRScan({
	                        ...
	                        if (ret.result == '1') {
	                            self.hCode = ret.hCode;
	                            Utils.fetch({
	                                url: '/yjpclass/bindHCode',
	                                data: 'classId=' + self.classId + '&hCode=' + self.hCode,
	                                type: 'json',
	                                method: 'POST',
	                                success: function success(ret) {
	                                    if (ret.data.retcode == '1') {
	        ...
	        unBingdingBox: function unBingdingBox() {
	            var hCode = null;
	            var self = this;
	            console.log(self.classId);
	            Utils.fetch({
	                url: '/yjpclass/bindHCode',
	                data: 'classId=' + self.classId + '&hCode=' + hCode,
	                type: 'json',
	                method: 'POST',
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	        ...
	        babyIn: function babyIn(e) {
	            this.childName = e.value.replace(/\s/g, "");
	        },
	        addBaby: function addBaby(e) {
	            var self = this;
	            if (self.childName == '' || self.childName == 'undefined') {
	                modal.alert({
	                    message: '请输入宝贝姓名',
	                    okTitle: '好的'
	                }, function () {});
	            ...
	            Utils.fetch({
	                url: '/classChildren/create',
	                data: 'classId=' + this.classId + '&childName=' + this.childName,
	                type: 'json',
	                method: 'POST',
	                success: function success(ret) {
	                    if (ret.data.retcode == '1') {
	                        var obj = {};
	                        obj.child_name = self.childName;
	                        Utils.fetch({
	                            url: '/yjpclass/classMemberInfo',
	                            data: 'classId=' + self.classId,
	                            type: 'json',
	                            ...
	                            success: function success(res) {
	                                if (ret.data.retcode == '1') {
	                                    obj.id = res.data.childrenList[res.data.childrenList.length - 1].id;
	                                    if (obj.avatar == null) {
	                                        obj.avatar = self.images.defaultPhoto;
	                                    }
	        ...
	        setPhotoUrlTea: function setPhotoUrlTea(i, photo) {
	            var self = this;
	            if (photo) {
	                self.teachers[i].photo = Utils.ip + self.dir + self.teachers[i].photo;
	            } else {
	                self.teachers[i].photo = self.images.defaultPhoto;
	            }
	        },
	        setPhotoUrlChil: function setPhotoUrlChil(j, avatar) {
	            var self = this;
	            if (avatar) {
	                self.children[j].avatar = Utils.ip + self.dir + self.children[j].avatar;
	            } else {
	                self.children[j].avatar = self.images.defaultPhoto;
	            }
	        }
