...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/b38a21da2d34def89d5afa8572f4b80d', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/b38a21da2d34def89d5afa8572f4b80d',undefined,undefined)
	    ...
	    created: function created() {
	        ...
	        setTimeout(function () {
	            storage.getItem('childrenList', function (e) {
	                console.log('info-health:' + e.data);
	                if (e.data != 'undefined') {
	                ...
	                for (var i in self.childrenList) {
	                    for (var j in self.childrenList[i].radioStatus) {
	                        ...
	                        self.childrenList[i].radioStatus[j].status = j == 1 ? self.images.selectRadio : self.images.blankRadio;
	                    }
	                }
	            });
	        }, 200);
