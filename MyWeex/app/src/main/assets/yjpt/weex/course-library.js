...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/fd64c2243bb76c99907a63b49a688bbc', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/fd64c2243bb76c99907a63b49a688bbc',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    created: function created() {
	        ...
	        Utils.changeImg(this.images, ['rightArrow']);
	            ...
	            if (e.data) {
	                ...
	                Utils.fetch({
	                    ...
	                    success: function success(ret) {
	                        ...
	                        for (var i = 0; i < self.lessonDirList.length; i++) {
	                            self.setPhoto(i);
	                        }
	                    }
	                });
	    ...
	    methods: {
	        ...
	        selected: function selected(index) {
	            ...
	            stream.fetch({
	                headers: headers,
	                method: "POST",
	                url: Utils.ip + 'yjpt' + '/lessonDir/searchDir',
	                type: 'JSON',
	                body: 'dirType=' + self.dirType + '&gradeId=' + '1'
	            }, function (response) {
	                if (!response.ok || response.ok == 0) {
	                    modal.toast({
	                        'message': '网络故障，请稍后再试！',
	                    ...
	                    var ret = response;
	                    if (data.retcode == '1') {
	                        self.lessonDirList = JSON.parse((0, _stringify2.default)(data.lessonDirList));
	                        for (var i = 0; i < self.lessonDirList.length; i++) {
	                            self.setPhoto(i);
	                        }
	                    } else {
	        ...
	        setPhoto: function setPhoto(i) {
	            ...
	            storage.getItem('jsessionid', function (e) {
	                if (e.data) {
	                    self.lessonDirList[i].preview = Utils.ip + self.dir + self.lessonDirList[i].preview + '?jsessionid=' + e.data;
	                }
	            });
	        }
	    }
