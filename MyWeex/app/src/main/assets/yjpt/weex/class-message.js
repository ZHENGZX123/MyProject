...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/cab5d1c7ad74584543a891cb634e9c09', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/cab5d1c7ad74584543a891cb634e9c09',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.redirect(this.msgUrl,$event)}
	          },
	          "children": [
	            {
	              "type": "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        navBarHeight: 130,
	        dir: 'yjpt',
	        url: 'class-message-new',
	        msgUrl: 'sx_xq',
	        msgList: [{ msgTitle: '今天的数学作业为.', msgFrom: '小美的家长', msgDate: '一周前' }, { msgTitle: '今天的数学作业为.', msgFrom: '小美她妈', msgDate: '刚刚' }],
	        images: {
	            leftItemImg: 'yjpt/images/id_right_bg.png',
	            rightItemImg: 'yjpt/images/plus.png'
	        }
	    }},
	    created: function created() {
	        ...
	        this.msgUrl = base + this.msgUrl + '.js';
