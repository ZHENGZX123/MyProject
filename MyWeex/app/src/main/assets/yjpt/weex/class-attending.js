...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/4c4ecbce472a0237a213b934202b315c', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/4c4ecbce472a0237a213b934202b315c',undefined,undefined)
	...
	module.exports = {
	  ...
	  "children": [
	          ...
	          "children": [
	            {
	              "type": "image",
	              "attr": {
	                "src": function () {return this.baoheImg}
	              },
	              "classList": [
	                "item_img"
	              ]
	          ...
	          "children": [
	            {
	              "type": "image",
	              "attr": {
	                "src": function () {return this.ewmImg}
	              },
	              "classList": [
	                "item_img"
	              ]
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.QRScan(this.url,$event)}
	              },
	    ...
	    },
	    {
	      ...
	      "shown": function () {return !this.isSelectClass},
	      "children": [
	        {
	          "type": "div",
	          "classList": [
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        baoheImg: 'yjpt/images/baohe.png',
	        ewmImg: 'yjpt/images/sao.png',
	        url: 'my-attend-class',
	        classList: [],
	        pageTitle: '我要上课',
	        isSelectClass: false,
	    ...
	    created: function created() {
	        ...
	        this.baoheImg = Utils.changeImg(this.baoheImg);
	        this.ewmImg = Utils.changeImg(this.ewmImg);
	    ...
	    methods: {
	        ...
	        selectClass: function selectClass(i) {
	            var self = this;
	            self.pageTitle = self.classList[i].className;

	            storage.setItem('pageTitle', self.pageTitle, function () {});
	            storage.setItem('gradeId', self.classList[i].gradeId, function () {});
	            storage.setItem('classId', self.classList[i].id, function () {});

	            if (self.classList[i].hCode != 'null' && self.classList[i].hCode != null) {
	                self.binding = true;
	                Utils.navigate.push(this, self.url, 'true');
	            } else {
	                self.binding = false;
	            }
	            self.isSelectClass = !self.isSelectClass;
	        },
