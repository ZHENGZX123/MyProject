...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/9762268a4fe6e9c89579dd6b0baefffd', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/9762268a4fe6e9c89579dd6b0baefffd',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "repeat": function () {return this.multiList},
	      "events": {
	        "click": function ($event) {this.checkBox(this.$index,$event)}
	      },
	      "children": [
	        {
	          "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    images: {
	      blankCheckbox: 'yjpt/images/blank-checkbox.png',
	      selectCheckbox: 'yjpt/images/select-checkbox.png'
	    },
	    allChecked: '',
	    multiList: []
	  }},
	  created: function created() {
	    var self = this;
	    Utils.changeImg(this.images, ['blankCheckbox', 'selectCheckbox']);
	    for (var i in self.multiList) {
	      this.multiList[i].imgUrl = self.images.blankCheckbox;
	    }
	    this.allChecked = Utils.ip + 'templates/images/blank-checkbox.png';
	  },
	  methods: {
	    checkBox: function checkBox(index) {
	      var self = this;
	      var flag = 0;
	      self.multiList[index].imgUrl = self.multiList[index].imgUrl == self.images.blankCheckbox ? self.images.selectCheckbox : self.images.blankCheckbox;

	      for (var i in self.multiList) {
	        if (self.multiList[i].imgUrl == self.images.blankCheckbox) {
	          self.allChecked = self.images.blankCheckbox;
	        } else if (self.multiList[i].imgUrl == self.images.selectCheckbox) {
	          flag++;
	        }
	      }
	      if (flag == self.multiList.length) self.allChecked = self.images.selectCheckbox;
	    }
