...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/1bb73b937a6a899a42471ceff412b21f', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/1bb73b937a6a899a42471ceff412b21f',undefined,undefined)
	    ...
	    created: function created() {
	        ...
	        this.$on('naviBar.rightItem.click', function (e) {
	            Utils.fetch({
	                ...
	                data: 'userId=' + userId + '&realName=' + this.userName,
	                type: 'json',
	                method: 'POST',
	                success: function success(ret) {
	                    ...
	                    if (obj.retcode == '1') {
	                        ...
	                        setTimeout(function () {
	                            storage.getItem('isNewUser', function (e) {
	                                if (e.data != 'undefined') {
	    ...
	    methods: {
	        userNameIn: function userNameIn(e) {
	            ...
	            if (this.countRemain <= 0) {
	                this.countRemain = 0;
	                this.userName = e.value.substring(0, this.numberCount);
	            }
	        }
	    }
	};}
