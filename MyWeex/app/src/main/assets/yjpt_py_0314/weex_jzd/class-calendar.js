	              ...
	              for (var i in arr) {
	                  ...
	                  if(subArrName){
	                    ...
	                    for(var k in subObj){
	                      if(k==imgNameArr[j]){
	                          osubOjb = subObj[k];
	                          subObj[imgNameArr[j]] = Utils.ip + osubOjb;
	                      }
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.openUrl('1',this.id,this.sectionType?'teacher':null,$event)}
	                  },
	                  "children": [
	                    {
	                      "type": "div",
	                        ...
	                        },
	                        {
	                          ...
	                          "children": [
	                            ...
	                            },
	                            {
	                              ...
	                              "events": {
	                                "click": function ($event) {this.openUrl('2',this.id,this.sectionType?'teacher':null,$event)}
	                              },
	                              "attr": {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        selected: function selected(index) {
	            ...
	            if (index == 0) {
	                self.courseType = 'all', Utils.fetch({
	        ...
	        openUrl: function openUrl(opType, sectionId, sectionType) {
	            var self = this;
