...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/d31338b79f1f5d349d7c8969d3fd6520', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/d31338b79f1f5d349d7c8969d3fd6520',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "repeat": function () {return this.gender},
	          "events": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        gender: [{ whether: '公开', status: '', type: '1' }, { whether: '不公开', status: '', type: '2' }],
	        wnumb: '1'
	    }},
	    created: function created() {
	        ...
	        storage.getItem('sfgk', function (e) {
	            ...
	            for (var i in self.gender) {
	                if (self.gender[i].type == self.wnumb) {
	        ...
	        this.$on('naviBar.rightItem.click', function (e) {
	            storage.setItem('sfgk', self.wnumb, function (e) {});
	            var url = Utils.setOpenUrl(self.$getConfig(), 'wdxc_fbwz');
