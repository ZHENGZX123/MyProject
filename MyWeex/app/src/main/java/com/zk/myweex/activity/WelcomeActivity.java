...
public class WelcomeActivity extends WXBaseActivity {
    ...
    private void checkIsFirst() {
        if (getSharedPreferences("kiway", 0).getBoolean("isFirst", true)) {
            ...
            //2.拷贝。。。
            FileUtils.copyRawToSdcard(this, R.raw.yjpt, "tab0.zip");
            FileUtils.copyRawToSdcard(this, R.raw.yjpt, "tab1.zip");
            FileUtils.copyRawToSdcard(this, R.raw.yjpt, "tab2.zip");
